...
Status: Phase 0 (scaffold). Nothing in this directory is approved yet.
...
|---|---|---|---|---|
| 1 | Three approved matrices, at most 8 actions each | `matrices/google.json`, `matrices/microsoft.json`, `matrices/slack.json` | `check_capability_matrices.py`: included-action cap, required fields, enums | seed rows, all `defer` |
...
| 1 | `matrices/google.json` fully sourced | no |
