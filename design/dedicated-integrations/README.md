...
|---|---|---|---|---|
| lfx owner | `connection-contract.md`, `ga-swap-procedure.md`, `decisions/substrate-google.md`, `decisions/substrate-microsoft.md`, `decisions/substrate-slack.md`, `decisions/kb-oauth-connector-adoption.md`, `cross-provider-capabilities.md` | | | |
| langflow-base owner | `connection-contract.md`, `decisions/substrate-google.md`, `decisions/substrate-microsoft.md`, `decisions/substrate-slack.md`, `decisions/google-restricted-scopes.md`, `decisions/kb-oauth-connector-adoption.md`, `decisions/desktop-oauth-ownership.md`, `decisions/broad-content-read.md`, `decisions/instance-connection-referenceability.md` | | | |
| Enterprise owner | `connection-contract.md`, `decisions/substrate-google.md`, `decisions/substrate-microsoft.md`, `decisions/substrate-slack.md`, `decisions/google-restricted-scopes.md`, `decisions/broad-content-read.md`, `decisions/instance-connection-referenceability.md` | | | |
