...
# Copy langflow-core metadata since it is a workspace member. The all-extras
# image does not install this sibling distribution, but uv still validates all
# workspace members during dependency resolution.
