...
test(
    ...
    async ({ page }) => {
        ...
        await page.getByTestId("div-generic-node").getByText("Language Model", { exact: true }).click();
        ...
        await expect(page.getByText("Cannot change visibility of connected handles")).toBeVisible();
