...
interface AIMLComponentProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}

export const AIMLComponent = React.forwardRef<SVGSVGElement, AIMLComponentProps>(
  ({ className, ...props }, ref) => (
    <svg
      ref={ref}
...
AIMLComponent.displayName = "AIMLComponent";