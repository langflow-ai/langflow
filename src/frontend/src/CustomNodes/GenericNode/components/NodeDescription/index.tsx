        ...
        >
          {description === "" || !description ? (
            ...
            <Markdown
              linkTarget="_blank"
              className={cn(
                "markdown [&_pre]:!bg-code-description-background [&_pre_code]:!bg-code-description-background prose flex w-full flex-col text-[13px] leading-5 word-break-break-word",
                mdClassName,
              )}
            >
              {String(description)}
