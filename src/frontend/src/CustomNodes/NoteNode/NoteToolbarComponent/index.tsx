...
export default function NoteToolbarComponent({ data,bgColor }: { data: noteDataType,bgColor:string }) {
            ...
            <div className="w-26 noflow nowheel nopan nodelete nodrag h-10">
                <span className="isolate inline-flex rounded-md shadow-sm">
                    <Popover>
                        ...
                        <PopoverContent side="top" className="w-fit py-2 px-2">
                            <div className="flex flew-row gap-3">
                                {Object.entries(COLOR_OPTIONS).map(([color,code]) => {
                                    return (
                                        ...
                                        >
                                            <div
                                                className={cn("h-4 w-4 rounded-full hover:border-ring hover:border",bgColor===color?"border-blue-500 border-2":"")}
                                                style={{
