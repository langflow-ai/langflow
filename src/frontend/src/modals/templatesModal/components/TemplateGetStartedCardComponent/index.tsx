...
export default function TemplateGetStartedCardComponent({
  ...
  return flow ? (
    <div
      className="group focus-visible:border-ring relative flex h-full min-h-[200px] w-full cursor-pointer flex-col overflow-hidden rounded-3xl border md:min-h-[250px]"
      tabIndex={1}
