...
export default function TemplateCardComponent({
  ...
  return (
    ...
    >
      <div
        className="relative h-40 overflow-hidden rounded-xl p-4 brightness-[90%] contrast-125 saturate-[80%]"
        style={{
          backgroundImage:
      ...
      >
        ...
        <IconComponent
          ...
          className="absolute left-1/2 top-1/2 h-10 w-10 -translate-x-1/2 -translate-y-1/2 !stroke-1 text-white opacity-25 mix-blend-plus-lighter duration-300 group-hover:scale-105 group-hover:opacity-50"
        />
      </div>
