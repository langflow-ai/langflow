...
describe("Message Ordering Regression Tests - GitHub Issue #9186", () => {
  describe("Production scenarios that caused ordering issues", () => {
    it("should handle identical timestamps from PostgreSQL with second precision", () => {
      ...
      const messages = [
        createMessage("ai-response", "2025-08-29 08:51:21 UTC", false, "I'm an AI language model"),
        createMessage("user-question", "2025-08-29 08:51:21 UTC", true, "Who are you?"),
      ];
    ...
    it("should handle streaming responses with load balancer timing", () => {
      ...
      const messages = [
        createMessage("stream-chunk-2", "2025-08-29 08:51:21 UTC", false, "models currently"),
        createMessage("user-input", "2025-08-29 08:51:21 UTC", true, "what models do you support?"),
        createMessage("stream-chunk-1", "2025-08-29 08:51:21 UTC", false, "It seems there are various"),
      ];
    ...
    it("should handle rapid-fire user questions with immediate AI responses", () => {
      ...
      const messages = [
        createMessage("ai-2", "2025-08-29 08:51:22 UTC", false, "Second AI response"),
        createMessage("user-2", "2025-08-29 08:51:22 UTC", true, "Second question"),
        createMessage("ai-1", "2025-08-29 08:51:21 UTC", false, "First AI response"), 
        createMessage("user-1", "2025-08-29 08:51:21 UTC", true, "First question"),
        createMessage("ai-3", "2025-08-29 08:51:23 UTC", false, "Third AI response"),
        createMessage("user-3", "2025-08-29 08:51:23 UTC", true, "Third question"),
      ];

      const sorted = [...messages].sort(sortSenderMessages);

      // Expected chronological order: User → AI → User → AI → User → AI
      const expectedOrder = ["user-1", "ai-1", "user-2", "ai-2", "user-3", "ai-3"];
    ...
    it("should handle timezone discrepancy scenarios", () => {
      ...
      const messages = [
        createMessage("ai-utc", "2025-08-29 08:51:21 UTC", false, "AI response in UTC"),
        ...
        createMessage("ai-iso", "2025-08-29T08:51:21Z", false, "AI response ISO"),
        createMessage("user-iso", "2025-08-29T08:51:21Z", true, "User message ISO"),
      ];
  ...
  describe("Backend streaming edge cases", () => {
    it("should handle Agent component message generation", () => {
      ...
      const messages = [
        createMessage("agent-step-2", "2025-08-29 08:51:21 UTC", false, "Agent processing step 2"),
        createMessage("user-query", "2025-08-29 08:51:21 UTC", true, "Process this request"),
        createMessage("agent-step-1", "2025-08-29 08:51:21 UTC", false, "Agent processing step 1"),
        createMessage("agent-result", "2025-08-29 08:51:21 UTC", false, "Agent final result"),
      ];
      ...
      expect(agentMessages.map(m => m.id)).toEqual([
        "agent-step-2", "agent-step-1", "agent-result"
      ]);
    });
    ...
    it("should handle message updates during streaming", () => {
      ...
      const messages = [
        createMessage("stream-final", "2025-08-29 08:51:21 UTC", false, "Complete response"),
        createMessage("user-msg", "2025-08-29 08:51:21 UTC", true, "User message"),
        createMessage("stream-partial", "2025-08-29 08:51:21 UTC", false, "Partial resp..."),
      ];
  ...
  describe("Database precision and rounding", () => {
    ...
    it("should handle microsecond precision loss", () => {
      ...
      const originalMessages = [
        { timestamp: "2025-08-29 08:51:21.123456 UTC", isSend: false, id: "ai-micro" },
        { timestamp: "2025-08-29 08:51:21.123456 UTC", isSend: true, id: "user-micro" },
      ];
  ...
  describe("Real conversation patterns", () => {
    it("should handle typical question-answer flow", () => {
      ...
      const conversation = [
        ...
        createMessage("ai-3", "2025-08-29 08:51:25 UTC", false, "Python is great for beginners because..."),
        createMessage("user-3", "2025-08-29 08:51:25 UTC", true, "What programming language should I learn?"),
        
        // First exchange
        createMessage("ai-1", "2025-08-29 08:51:21 UTC", false, "Hello! I'm an AI assistant. How can I help you?"),
        createMessage("user-1", "2025-08-29 08:51:21 UTC", true, "Hello"),
        
        // Second exchange
        createMessage("user-2", "2025-08-29 08:51:23 UTC", true, "Can you help me with coding?"),
        createMessage("ai-2", "2025-08-29 08:51:23 UTC", false, "Absolutely! I'd be happy to help you with coding."),
      ];
    ...
    it("should handle error messages and system messages", () => {
      ...
      const messages = [
        createMessage("error-msg", "2025-08-29 08:51:21 UTC", false, "Error: Connection timeout"),
        createMessage("user-retry", "2025-08-29 08:51:21 UTC", true, "Can you try again?"),
        createMessage("user-original", "2025-08-29 08:51:21 UTC", true, "What's the weather?"),
        createMessage("ai-response", "2025-08-29 08:51:21 UTC", false, "I don't have access to weather data"),
      ];
  ...
  describe("Backwards compatibility", () => {
    it("should maintain sort stability for pre-fix messages", () => {
      ...
      const legacyMessages = [
        createMessage("legacy-ai", "2025-08-29 08:50:23 UTC", false, "Code: None"),
        createMessage("legacy-user", "2025-08-29 08:50:24 UTC", true, "Who are you?"),
      ];
