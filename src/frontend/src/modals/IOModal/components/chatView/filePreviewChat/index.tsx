...
export default function FilePreview({
  ...
  return (
    <div className="relative inline-block">
      {loading ? (
        <div className="flex h-24 w-24 items-center justify-center rounded-md border border-ring bg-background bg-muted">
          <svg
            aria-hidden="true"
        ...
        <div
          className={`relative h-24 w-24 rounded-md border border-ring  bg-background bg-muted transition duration-300 ${
            isHovered ? "shadow-md" : ""
          }`}
        ...
        >
          <img
            ...
            alt="file"
            className="block h-full w-2 w-full rounded-md border border-border"
          />
          {isHovered && (
