                                    ...
                                    {template ? (
                                        ...
                                        <div className="flex flex-col w-full">
                                            {editMessage ? (
                                                ...
                                                <>
                                                    <div
                                                        className={`flex gap-2 whitespace-pre-wrap break-words w-full ${isEmpty ? "text-chat-trigger-disabled" : "text-primary"
                                                            }`}
          ...
          >
            ...
            <div className="flex w-full flex-col">
              ...
              {!chat.isSend ? (
                      ...
                      >
                        ...
                        >
                          {chatMessage === "" && lockChat ? (
                            ...
                            <div
                              className="w-full"
                              onDoubleClick={() => setEditMessage(true)}
                            >
                              {editMessage ? (
                                <EditMessageField
                                  key={`edit-message-${chat.id}`}
                ...
                <div className="form-modal-chat-text-position w-full min-w-96 flex-grow">
                  {template ? (
                    <>
                      <button
                        className="form-modal-initial-prompt-btn"
