    ...
    >
      ...
      <BaseModal.Content overflowHidden>
        <div className="flex-max-width h-full flex-col">
          <div className="flex h-[3%] w-full items-center text-lg">
            <Button
              variant="ghost"
              size="icon"
            ...
            <div
              className={cn(
                "pl-1 font-semibold transition-all duration-300",
                sidebarOpen ? "" : "hidden",
              )}
            >
              Playground
            ...
            <div
              className={cn(
                "w-4/5 font-semibold",
                sidebarOpen ? "ml-auto" : "pl-1",
              )}
            >
              Build a new tool
            </div>
          </div>
          <div className="maxw-full flex h-[97%]">
            <div
              className={cn(
            ...
            >
              <div
                className={cn(
                  "flex h-full flex-col overflow-y-auto bg-background pr-4 pt-8 text-center custom-scroll",
                  sidebarOpen ? "" : "hidden",
                )}
              >
