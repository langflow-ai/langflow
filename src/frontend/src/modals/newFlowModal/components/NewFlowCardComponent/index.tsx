  ...
  return (
    ...
    >
      <CardContent className="h-full w-full">
        <div className="bg-muted bg-dotted-spacing-6 bg-dotted-muted-foreground bg-dotted-radius-px flex h-full w-full flex-col items-center justify-center rounded-md align-middle"></div>
      </CardContent>
