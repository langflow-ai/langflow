...
interface DeploymentTableRowProps {
  ...
  colSpan: number;
  isExpanded: boolean;
  onToggleExpanded: (deploymentId: string) => void;
...
export default function DeploymentTableRow({
  deployment,
  providerName,
  deletingId,
  colSpan,
  ...
  return (
    <Fragment>
      ...
      >
        ...
        <TableCell>
          <button
            ...
            onClick={() => onToggleExpanded(deployment.id)}
          ...
          {isDeleting ? (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => onViewDetails?.(deployment)}>
                  <ForwardedIconComponent
                    name="Info"
      ...
      {isExpanded && (
        <DeploymentExpandedRow deploymentId={deployment.id} colSpan={colSpan} />
      )}
    </Fragment>
  );
}
