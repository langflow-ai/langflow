      ...
      {showCanvas ? (
        <div id="react-flow-id" className="h-full w-full bg-canvas">
          ...
          >
            ...
            <Panel
              className={cn(
                "react-flow__controls m-2! flex gap-1.5 rounded-md border border-secondary-hover bg-background fill-foreground stroke-foreground p-1.5 text-primary shadow-2xs transition-all duration-300 [&>button]:border-0 [&>button]:bg-background [&>button]:hover:bg-accent",
