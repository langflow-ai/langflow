...
export const MemoizedSidebarTrigger = memo(() => (
  <Panel
    className={cn(
      "react-flow__controls !top-auto !m-4 flex gap-1.5 rounded-md border border-secondary-hover bg-background fill-foreground stroke-foreground p-1.5 text-primary shadow transition-all duration-300 [&>button]:border-0 [&>button]:bg-background hover:[&>button]:bg-accent",
