...
export const FlowDraggableComponent = forwardRef(
  (
    {
      sectionName,
      display_name,
    ...
    return (
      ...
      >
        <ShadTooltip
          content={flow.description || display_name}
          styleClasses="z-50"
        >
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex flex-1 items-center overflow-hidden">
                ...
                {flow.is_component && (
                  <ShadTooltip content="Component Flow" styleClasses="z-50">
                    <ForwardedIconComponent
                      name="component"
...
export default FlowDraggableComponent;