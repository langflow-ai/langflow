...
jest.mock("../components/InspectionPanelHeader", () => {
    return function MockInspectionPanelHeader({ data, onClose }: any) {
        return (
...
describe("InspectionPanel", () => {
    ...
    describe("Close Functionality", () => {
        it("should call onClose when provided", async () => {
            ...
            render(<InspectionPanel selectedNode={mockNode} onClose={onClose} />);
    ...
    describe("Component Integration", () => {
        ...
        it("should use node id as key for InspectionPanelFields", () => {
            ...
            const { container } = render(
                <InspectionPanel selectedNode={mockNode} />,
            );
