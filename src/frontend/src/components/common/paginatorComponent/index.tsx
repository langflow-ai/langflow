...
export default function PaginatorComponent({
  ...
  return (
    <div className="flex flex-1 items-center justify-between px-6">
      <div className="flex items-center justify-end gap-1 text-xs text-secondary-foreground">
      ...
      <div className={"flex items-center gap-2"}>
        <div className="flex items-center gap-1 text-xs text-secondary-foreground">
          ...
          >
            <SelectTrigger
              direction="up"
              className="h-7 w-fit gap-1 border-none p-1 pl-1.5 text-xs focus:border-none focus:ring-0 focus:!ring-offset-0"
            >
