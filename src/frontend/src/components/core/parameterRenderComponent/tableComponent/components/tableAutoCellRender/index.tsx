...
import NumberReader from "@/components/core/numberReader";
import ObjectRender from "@/components/core/objectRender";
import StringReader from "@/components/core/stringReaderComponent";
