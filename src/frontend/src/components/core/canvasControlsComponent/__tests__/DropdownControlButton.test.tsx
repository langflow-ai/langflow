...
jest.mock("../../parameterRenderComponent/components/toggleShadComponent", () => ({
  __esModule: true,
...
describe("DropdownControlButton", () => {
  ...
  it("sets tooltip text as title attribute", () => {
    ...
    render(<DropdownControlButton {...defaultProps} tooltipText={tooltipText} />);
  ...
  it("renders toggle component when hasToogle is true", () => {
    ...
    expect(screen.getByTestId("toggle-helper_lines")).toHaveAttribute("data-value", "true");
  });
  ...
  it("passes toggle value correctly to toggle component", () => {
    ...
    expect(screen.getByTestId("toggle-helper_lines")).toHaveAttribute("data-value", "false");
  });
