...
function FaviconImg() {
  // A local globe icon instead of fetching from a third party: in on-prem /
  // privacy-sensitive deployments the favicon request would leak every cited
  // source domain to an external endpoint, hostname by hostname.
  return (
