  ...
  <DialogPortal>
    ...
    >
      ...
      <ShadTooltip
        ...
        avoidCollisions
      >
        <DialogPrimitive.Close className="ring-offset-background hover:bg-secondary-hover hover:text-accent-foreground focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-2 right-2 flex h-8 w-8 items-center justify-center rounded-sm transition-opacity focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:pointer-events-none">
