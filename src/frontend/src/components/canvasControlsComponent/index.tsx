...
const CanvasControls = ({ children }) => {
  ...
  return (
    <Panel
      ...
      className="react-flow__controls flex gap-1.5 rounded-md bg-background fill-foreground stroke-foreground shadow !m-2 border border-secondary-hover p-1.5 text-primary [&>button]:border-0 [&>button]:bg-background hover:[&>button]:bg-accent"
