...
import { CsgIcon } from "../icons/CSG";
import { AmdocsIcon } from "../icons/Amdocs";
import { OracleIcon } from "../icons/Oracle";
import { EricssonIcon } from "../icons/Ericsson";
...
export const SIDEBAR_BUNDLES = [
  ...
  { display_name: "Telco Ontology", name: "totogi_ontology", icon: "Totogi" },
  { display_name: "Totogi", name: "totogi", icon: "Totogi" },
  { display_name: "CSG", name: "csg", icon: "CSG" },
  { display_name: "Amdocs", name: "amdocs", icon: "Amdocs" },
  { display_name: "Oracle", name: "oracle", icon: "Oracle" },
  { display_name: "Ericsson", name: "ericsson", icon: "Ericsson" },
// // ];
