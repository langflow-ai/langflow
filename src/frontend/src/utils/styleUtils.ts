...
export const SIDEBAR_CATEGORIES = [
  {
    display_name: i18n.t("category.saved", "已保存"),
    name: "saved_components",
    icon: "GradientSave",
  },
  {
    display_name: i18n.t("category.input_output", "输入 & 输出"),
    name: "input_output",
    icon: "Cable",
  },
  {
    display_name: i18n.t("category.data_sources", "数据源"),
    name: "data_source",
    icon: "Database",
  },
  {
    display_name: i18n.t("category.models_and_agents", "模型 & 智能体"),
  ...
  {
    display_name: i18n.t("category.processing", "处理"),
    name: "processing",
    icon: "ListFilter",
  },
  {
  ...
  {
    display_name: i18n.t("category.utilities", "实用工具"),
    name: "utilities",
    icon: "Wand2",
  },
  {
    display_name: i18n.t("category.prototypes", "原型"),
    name: "prototypes",
    icon: "FlaskConical",
  },
  {
    display_name: i18n.t("category.tools", "工具"),
    name: "tools",
    icon: "Hammer",
  },
  {
    display_name: i18n.t("category.agents", "智能体"),
    name: "agents",
    icon: "Bot",
  },
  {
    display_name: i18n.t("category.data", "数据"),
    name: "data",
    icon: "Database",
  },
  {
    display_name: i18n.t("category.logic", "逻辑"),
    name: "logic",
    icon: "ArrowRightLeft",
  },
  {
    display_name: i18n.t("category.helpers", "助手"),
    name: "helpers",
    icon: "Wand2",
  },
  {
    display_name: i18n.t("category.models", "模型"),
    name: "models",
    icon: "BrainCog",
  },
  {
    display_name: i18n.t("category.vector_stores", "向量存储"),
    name: "vectorstores",
    icon: "Layers",
  },
  {
    display_name: i18n.t("category.inputs", "输入"),
    name: "inputs",
    icon: "Download",
  },
  {
    display_name: i18n.t("category.outputs", "输出"),
    name: "outputs",
    icon: "Upload",
  },
  {
    display_name: i18n.t("category.prompts", "提示词"),
    name: "prompts",
    icon: "braces",
  },
  {
    display_name: i18n.t("category.chains", "链"),
    name: "chains",
    icon: "Link",
  },
  {
    display_name: i18n.t("category.loaders", "加载器"),
    name: "documentloaders",
    icon: "Paperclip",
  },
  {
    display_name: i18n.t("category.link_extractors", "链接提取器"),
    name: "link_extractors",
    icon: "Link2",
  },
  {
    display_name: i18n.t("category.output_parsers", "输出解析器"),
    name: "output_parsers",
    icon: "Compass",
  },
  {
    display_name: i18n.t("category.retrievers", "检索器"),
    name: "retrievers",
    icon: "FileSearch",
  },
  {
    display_name: i18n.t("category.text_splitters", "文本分割器"),
    name: "textsplitters",
    icon: "Scissors",
  },
  {
    display_name: i18n.t("category.toolkits", "工具包"),
    name: "toolkits",
    icon: "Package2",
  },
];
