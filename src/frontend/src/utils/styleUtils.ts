...
export const nodeIconsMapping: Record<string, () => Promise<any>> = {
  ...
  // Other icons
  FaApple: () => Promise.resolve({ default: FaApple }),
  FaDiscord: () => Promise.resolve({ default: FaDiscord }),
  FaGithub: () => Promise.resolve({ default: FaGithub }),
  TwitterLogoIcon: () => Promise.resolve({ default: TwitterLogoIcon }),
};
...
// // For backward compatibility, we can keep nodeIconsLucide as a proxy
// export const nodeIconsLucide: iconsType = new Proxy({} as iconsType, {
//   get: (target, prop) => {
//     if (typeof prop === 'string') {
//       return getNodeIcon(prop);
//     }
//     return undefined;
//   }
// });
