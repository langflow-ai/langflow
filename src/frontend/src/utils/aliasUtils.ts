...
/**
 * Check if an alias is auto-generated based on pattern matching
 */
export function isAutoGeneratedAlias(
  alias: string,
  displayName: string,
): boolean {
...
/**
 * Check if an alias is user-defined (not matching auto-generated pattern)
 */
export function isUserDefinedAlias(
  alias: string,
  displayName: string,
): boolean {
  return !isAutoGeneratedAlias(alias, displayName);
}

/**
 * Safety check: Verify if it's safe to modify a component's alias
 * Only auto-generated aliases can be modified
 */
export function isSafeToModifyAlias(node: GenericNodeType): boolean {
  ...
  // Only safe to modify auto-generated aliases
  return isAutoGeneratedAlias(alias, displayName);
}
