...
export const API_PAGE_PARAGRAPH =
  "Your secret Agent Crafter API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Agent Crafter Chat";
...
export const STORE_TITLE = "Agent Crafter Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Agent Crafter API key.";
...
export const GITHUB_URL = "https://github.com/sochflow-ai/sochflow";
export const TWITTER_URL = "https://x.com/sochflow_ai";
export const DOCS_URL = "https://docs.sochflow.com";
