...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Brain Nairuz documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Brain Nairuz: Create, Chain, Communicate.",
  ...
  "Design Dialogues with Brain Nairuz.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Brain Nairuz API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Brain Nairuz Chat";
...
export const STORE_TITLE = "Brain Nairuz Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Brain Nairuz API key.";
