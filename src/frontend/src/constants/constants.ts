...
export const DEFAULT_SESSION_NAME = () =>
  t("session.default", "Default Session");
 ...
 *
 */
export const USER_PROJECTS_HEADER = () =>
  t("main.myCollection", "My Collection");
...
export const FETCH_ERROR_MESSAGE = () =>
  t("errors.connectionFailed", "Couldn't establish a connection.");
...
export const TIMEOUT_ERROR_MESSAGE = () =>
  t(
    "errors.requestProcessing",
    "Please wait a few moments while the server processes your request.",
  );
export const TIMEOUT_ERROR_DESCRIPION = () =>
  t("errors.serverBusy", "Server is busy.");

export const SIGN_UP_SUCCESS = () =>
  t("auth.signUpSuccess", "Account created! Await admin activation.");
...
export const LAST_USED_SPAN_1 = () =>
  t("settings.lastUsed", "The last time this key was used.");

export const LAST_USED_SPAN_2 = () =>
  t(
    "settings.lastUsedPrecise",
...
export const TOOLTIP_OUTDATED_NODE = () =>
  t(
    "tooltip.outdatedNode",
    "Your component is outdated. Click to update (data may be lost)",
  );

export const CHAT_SECOND_INITIAL_TEXT = () =>
  t("chat.secondInitial", "to inspect previous messages.");

export const TOOLTIP_OPEN_HIDDEN_OUTPUTS = () =>
  t("tooltip.expandOutputs", "Expand hidden outputs");
export const TOOLTIP_HIDDEN_OUTPUTS = () =>
  t("tooltip.collapseOutputs", "Collapse hidden outputs");

export const ZERO_NOTIFICATIONS = () =>
  t("common.noNotifications", "No new notifications");

export const SUCCESS_BUILD = () =>
  t("common.buildSuccess", "Built successfully ✨");

export const ALERT_SAVE_WITH_API = () =>
  t(
    "flow.alertSaveWithApi",
    "Caution: Unchecking this box only removes API keys from fields specifically designated for API keys.",
  );

export const SAVE_WITH_API_CHECKBOX = () =>
  t("flow.saveWithApiCheckbox", "Save with my API keys");
export const EDIT_TEXT_MODAL_TITLE = () => t("flow.editText", "Edit Text");
export const EDIT_TEXT_PLACEHOLDER = () =>
  t("flow.editTextPlaceholder", "Type message here.");
export const INPUT_HANDLER_HOVER = () =>
  t("tooltip.availableInputs", "Available input components:");
export const OUTPUT_HANDLER_HOVER = () =>
  t("tooltip.availableOutputs", "Available output components:");
...
export const CHAT_INPUT_PLACEHOLDER_SEND = () =>
  t("chat.sendPlaceholder", "Send a message...");
export const EDIT_CODE_TITLE = () => t("flow.editCode", "Edit Code");
export const MY_COLLECTION_DESC = () =>
  t(
    "main.myCollectionDesc",
    "Manage your projects. Download and upload entire collections.",
  );
export const STORE_DESC = () =>
  t("store.desc", "Explore community-shared flows and components.");
export const STORE_TITLE = () => t("store.title", "Langflow Store");
export const NO_API_KEY = () =>
  t("store.noApiKey", "You don't have an API key.");
export const INSERT_API_KEY = () =>
  t("store.insertApiKey", "Insert your Langflow API key.");
export const INVALID_API_KEY = () =>
  t("store.invalidApiKey", "Your API key is not valid.");
export const CREATE_API_KEY = () =>
  t("store.createApiKey", "Don't have an API key? Sign up at");
export const STATUS_BUILD = () =>
  t("flow.statusBuild", "Build to validate status.");
...
export const STATUS_INACTIVE = () =>
  t("flow.statusInactive", "Execution blocked");
