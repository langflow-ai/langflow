...
def get_storage_service():
    from services.storage.factory import StorageServiceFactory

    return get_service(ServiceType.STORAGE_SERVICE, StorageServiceFactory())


def get_variable_service():
    from services.variable.factory import VariableServiceFactory
