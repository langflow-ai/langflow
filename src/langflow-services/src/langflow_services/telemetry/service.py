...
from langflow_services.telemetry.opentelemetry import OpenTelemetry
from langflow_services.telemetry.schema import (
...
class TelemetryService(Service):
    ...
    async def _send_email_telemetry(self) -> None:
        ...
        get_email_model = get_hook("get_email_model")
        payload: EmailPayload | None = get_email_model() if get_email_model else None
