...
from langflow_services.memory_base.document_builders import (
    build_documents_from_messages,
    build_preprocessed_document,
    sync_kb_metadata,
)
from langflow_services.memory_base.kb_hooks import KBIngestionHelper, KBStorageHelper
from langflow_services.memory_base.kb_path_helpers import hash_session_id, validate_kb_path
from langflow_services.memory_base.preprocessing import DEFAULT_KILL_PHRASE, run_preprocessing
...
async def _is_postgres() -> bool:
    ...
    from langflow_services.deps import get_db_service

    db_service = get_db_service()
    engine = getattr(db_service, "engine", None)
