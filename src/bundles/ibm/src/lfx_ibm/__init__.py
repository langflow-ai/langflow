"""lfx-ibm: IBM bundle (Db2 Vector Store, watsonx.ai LLM and embeddings, watsonx.data Presto and MCP).
...
``__init__.py`` and registers the IBM components under the
namespaced IDs:
...
from lfx_ibm.components.ibm.watsonx_data_mcp import WatsonxDataMCPComponent
from lfx_ibm.components.ibm.watsonx_data_presto import WatsonxDataPrestoComponent
