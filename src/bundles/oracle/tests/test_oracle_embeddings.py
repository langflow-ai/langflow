...
def test_build_embeddings_returns_oracle_embeddings_instance():
    ...
    with (
        patch("lfx_oracle.components.oracle.oracledb_embeddings.OracleEmbeddings") as mock_oracle_embeddings,
        patch("lfx_oracle.components.oracle.oracledb_embeddings.oracledb.connect") as mock_connect,
    ):
...
@patch("lfx_oracle.components.oracle.oracledb_embeddings.OracleEmbeddings")
@patch("lfx_oracle.components.oracle.oracledb_embeddings.oracledb.connect")
