...
if TYPE_CHECKING:
    from lfx_bundles.codeagents.codeact_agent_smolagents import CodeActAgentSmolagentsComponent
    from lfx_bundles.codeagents.open_ds_star_agent import OpenDsStarAgentComponent
