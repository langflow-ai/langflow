...
class OrcaRouterComponent(LCModelComponent):
    ...
    description = (
        "OrcaRouter provides unified access to multiple AI models from different providers through a single API."
    )
    icon = "OrcaRouter"
    ...
    def fetch_models(self) -> list[dict]:
        ...
        try:
            response = httpx.get("https://api.orcarouter.ai/v1/models", timeout=10.0)
