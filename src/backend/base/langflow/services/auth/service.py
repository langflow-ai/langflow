...
class AuthService(BaseAuthService):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        # Cache for the last-secret -> Fernet mapping to avoid rebuilding Fernet repeatedly
    ...
    def _get_fernet(self) -> Fernet:
        ...
        if secret_key == self._cached_secret_key and self._cached_fernet is not None:
