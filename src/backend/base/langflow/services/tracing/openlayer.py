...
class OpenlayerTracer(BaseTracer):
    ...
    def setup_openlayer(self, config) -> bool:
        ...
        try:
            ...
            logger.opt(exception=True).debug("Openlayer tracer not initialized: unexpected error during setup")
            return False
        else:
            return True
    ...
    def end(
        ...
        try:
            ...
            logger.opt(exception=True).warning("Openlayer tracing/upload failed")
        finally:
