...
class RoutedPrompt(Component):
    ...
    documentation: str = "https://python.langchain.com/v0.1/docs/expression_language/how_to/routing/#using-a-custom-function-recommended"
    ...
    def build_output(self) -> Text:
        ...
        chain = (
            ...
            | RunnableLambda(lambda input: self._prompt_router(input, self.embedding, self.prompt_templates, prompt_embeddings))
            | self.llm
            | StrOutputParser()
        )
