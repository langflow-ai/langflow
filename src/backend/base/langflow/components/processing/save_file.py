...
class SaveToFileComponent(Component):
    ...
    def _create_dataframe_from_data(self, data) -> pd.DataFrame:
        ...
        try:
            ...
            msg = f"Error creating DataFrame from data: {e!s}"
            raise ValueError(msg)
    ...
    def _save_dataframe(self, dataframe: DataFrame, path: Path, fmt: str) -> None:
        ...
        if fmt == "csv":
            ...
            try:
                ...
                msg = f"Error saving DataFrame to Excel: {e!s}"
                raise ValueError(msg)
        elif fmt == "json":
    ...
    def _save_dataframe_list(self, dataframes: list, path: Path, fmt: str) -> None:
        ...
        if fmt == "csv":
            ...
            try:
                ...
                msg = f"Error saving DataFrames to Excel: {e!s}"
                raise ValueError(msg)
        elif fmt == "json":
    ...
    def _save_data(self, data: Data, path: Path, fmt: str) -> None:
        ...
        if fmt == "csv":
            ...
            try:
                ...
                msg = f"Error saving data to Excel: {e!s}"
                raise ValueError(msg)
        elif fmt == "json":
            path.write_text(
