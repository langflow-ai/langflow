...
#                     default_fields=self.default_keys,
#                 )
#             if "Remove Keys" in selected_actions and len(selected_actions) == 1:
#                 build_config["data"]["is_list"] = False
#                 logger.info("setting remove keys fields")
#                 build_config = set_current_fields(
#                     build_config=build_config,
#                     action_fields=self.actions_data,
#                     selected_action="Remove Keys",
#                     default_fields=self.default_keys,
#                 )
#             if "Rename Keys" in selected_actions and len(selected_actions) == 1:
#                 build_config["data"]["is_list"] = False
#                 logger.info("setting rename keys fields")
#                 build_config = set_current_fields(
#                     build_config=build_config,
#                     action_fields=self.actions_data,
#                     selected_action="Rename Keys",
#                     default_fields=self.default_keys,
#                 )
...
#         if "Remove Keys" in selected_actions and len(selected_actions) == 1:
#             if self.data_is_list():
#                 self.data_list_exception("Remove Keys")
#             return self.remove_keys()
#         if "Rename Keys" in selected_actions and len(selected_actions) == 1:
#             if self.data_is_list():
#                 self.data_list_exception("Rename Keys")
#             return self.rename_keys()
#         return None
