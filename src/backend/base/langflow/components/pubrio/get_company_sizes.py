...
class PubrioGetCompanySizesComponent(Component):
    display_name = "Pubrio Get Company Sizes"
    description = "Get all company size range codes."
    icon = "list"
    name = "PubrioGetCompanySizes"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/company_sizes")
