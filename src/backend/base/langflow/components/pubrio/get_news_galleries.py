...
class PubrioGetNewsGalleriesComponent(Component):
    display_name = "Pubrio Get News Galleries"
    description = "Get all news gallery codes."
    icon = "list"
    name = "PubrioGetNewsGalleries"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/companies/news/galleries")
