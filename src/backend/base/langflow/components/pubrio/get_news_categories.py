...
class PubrioGetNewsCategoriesComponent(Component):
    display_name = "Pubrio Get News Categories"
    description = "Get all news category codes."
    icon = "list"
    name = "PubrioGetNewsCategories"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/companies/news/categories")
