...
class PubrioLookupPersonComponent(Component):
    display_name = "Pubrio Lookup Person"
    description = "Look up a person by LinkedIn URL or people search ID."
    icon = "user"
    name = "PubrioLookupPerson"
    ...
    def run_lookup(self) -> DataFrame:
        ...
        result = pubrio_post(self.api_key, "/people/lookup", {lookup_type: value})
