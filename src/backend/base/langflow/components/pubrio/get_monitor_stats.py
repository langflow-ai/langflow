...
class PubrioGetMonitorStatsComponent(Component):
    display_name = "Pubrio Get Monitor Stats"
    description = "Get aggregate statistics across monitors."
    icon = "list"
    name = "PubrioGetMonitorStats"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/monitors/statistics")
