...
class PubrioGetDepartmentsComponent(Component):
    display_name = "Pubrio Get Departments"
    description = "Get all department title codes."
    icon = "list"
    name = "PubrioGetDepartments"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/departments/title")
