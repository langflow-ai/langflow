...
class DirectoryComponent(Component):
    ...
    inputs = [
        MessageTextInput(name="path", display_name="Path", info="Path to the directory to load files from."),
        MessageTextInput(
            name="types",
            display_name="Types",
        ...
        IntInput(name="depth", display_name="Depth", info="Depth to search for files.", value=0),
        IntInput(
        ...
        BoolInput(
            name="load_hidden", display_name="Load Hidden", advanced=True, info="If true hidden files will be loaded."
        ),
        BoolInput(
            name="recursive", display_name="Recursive", advanced=True, info="If true the search will be recursive."
        ),
        BoolInput(
            name="silent_errors",
    ...
    outputs = [Output(display_name="Data", name="data", method="load_directory")]
