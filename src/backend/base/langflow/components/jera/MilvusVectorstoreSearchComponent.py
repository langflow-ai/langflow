...
class MilvusVectorstoreSearchComponent(Component):
    display_name = "Milvus Vectorstore Search Component"
    description = "Milvus Vectorstore Searches a collection using a text query to retrieve relevant data."
    icon = "special_components"
    name = "MilvusVectorstoreSearchComponent"
    ...
    def build_output(self) -> Data:
        ...
        url = f"http://{SDCP_ROOT_URL}/embedding/milvus_vectorstore_search/"
