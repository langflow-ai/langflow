...
class DiagramExtractorComponent(Component):
    display_name = "Diagram Extractor Component"
    ...
    def build_output_data(self) -> Data:
        ...
        url = f"http://{SDCP_ROOT_URL}/diagram_extractor/extract_diagram_with_parser"
