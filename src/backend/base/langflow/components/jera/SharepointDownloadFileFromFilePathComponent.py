...
class SharepointDownloadFileFromFilePathComponent(Component):
    display_name = "Sharepoint Get File by Path"
    description = "Use this component to download a file from sharepoint."
    documentation: str = "http://docs.langflow.org/components/custom"
    icon = "download"
    name = "SharepointDownloadFileFromFilePathComponent"

    '''
    drive_name: str = Query("ドキュメント", description="The name of the shared document drive. Defaults to 'ドキュメント' if not provided."),
    file_path: str = Query(..., description="The path of the file in SharePoint."),
    ...
    inputs = [
        ...
        MessageTextInput(name="file_path", display_name="File path", required=True, info="The path of the file in SharePoint."),
