...
class EricssonCharger(LCToolComponent):
    display_name: str = "Ericsson Charger"
    description: str = "Configure and retrieve information from the Ericsson Charger."
    ...
    outputs = [
        Output(name="charger_info", display_name="Tool", method="build_tool"),
    ]

    class EricssonChargerSchema(BaseModel):
    ...
    def build_tool(self) -> Tool:
        ...
        return StructuredTool.from_function(
            name="ericsson_charger",
            description="Retrieve information from the Ericsson Charger.",
            func=self._get_charger_info,
            args_schema=self.EricssonChargerSchema,
        )

    def _get_charger_info(self, customer_id: str, fields: str) -> dict[str, Any] | str:
        try:
