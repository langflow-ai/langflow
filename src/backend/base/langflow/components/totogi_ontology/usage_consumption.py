...
class TotogiOntologyUsageConsumption(LCToolComponent):
    display_name = "Usage Consumption - GET"
    description = (
        "This component allows you to make HTTP requests to Totogi Ontology Usage Consumption"
    )
    name = "TotogiOntologyUsageConsumption"
    documentation: str = "https://docs-totogi-ontology.redoc.ly/openapi/usage/operation/retrieveUsageConsumption/"
    icon = "Totogi"
    method = "GET"
