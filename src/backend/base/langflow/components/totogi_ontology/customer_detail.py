...
class TotogiOntologyCustomerDetail(LCToolComponent):
    display_name: str = "Customer Detail - GET"
    description: str = "Retrieve customer details from the Totogi Ontology by customer ID."
    ...
    class TotogiOntologyCustomerDetailSchema(BaseModel):
    ...
    def build_tool(self) -> Tool:
        ...
        return StructuredTool.from_function(
            name="totogi_ontology_customer_detail_get",
            description="Retrieve customer details from the Totogi Ontology by customer ID.",
            func=self._get_customer_detail,
            args_schema=self.TotogiOntologyCustomerDetailSchema,
        )

    def _get_customer_detail(self, customer_id: str, fields: str) -> dict[str, Any] | str:
        try:
