...
class ComposioOutlookAPIComponent(ComposioBaseComponent):
    ...
    "OUTLOOK_OUTLOOK_GET_PROFILE": {
      ...
      "action_fields": [
        "OUTLOOK_OUTLOOK_GET_PROFILE_user_id"
      ]
    },
    "OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT": {
      "display_name": "Download Attachment",
      "action_fields": [
        "OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_user_id",
        "OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_message_id",
        "OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_attachment_id",
        "OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_file_name"
      ]
    },
    ...
    "OUTLOOK_OUTLOOK_UPDATE_EMAIL": {
      "display_name": "Update Email Message",
      "action_fields": [
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_user_id",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_message_id",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_subject",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_body",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_importance",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_cc_recipients",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_bcc_recipients",
        "OUTLOOK_OUTLOOK_UPDATE_EMAIL_to_recipients"
      ]
    },
    ...
    "OUTLOOK_OUTLOOK_GET_EVENT": {
      ...
      "action_fields": [
        "OUTLOOK_OUTLOOK_GET_EVENT_user_id",
        "OUTLOOK_OUTLOOK_GET_EVENT_event_id"
      ]
    },
    ...
    MessageTextInput(
        name="OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_user_id",
        display_name="User Id",
    ...
    MessageTextInput(
        name="OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_message_id",
        display_name="Message Id",
        info="Id of the message containing the attachment",
        show=False,
        required=True,
    ),
    MessageTextInput(
        name="OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_attachment_id",
        display_name="Attachment Id",
        info="Id of the target attachment",
        show=False,
        required=True,
    ),
    MessageTextInput(
        name="OUTLOOK_DOWNLOAD_OUTLOOK_ATTACHMENT_file_name",
        display_name="File Name",
        info="Filename of the attachment file",
        show=False,
        required=True,
    ),
    MessageTextInput(
    ...
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_user_id",
        display_name="User Id",
        info="The user's email address or 'me' for the authenticated user.",
        show=False,
        value="me",
    ...
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_message_id",
        display_name="Message Id",
        info="The ID of the message to update.",
        show=False,
        required=True,
    ),
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_subject",
        display_name="Subject",
        info="The subject of the message.",
        show=False,
    ),
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_body",
        display_name="Body",
        info="The body content of the message.",
        show=False,
    ),
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_importance",
        display_name="Importance",
        info="The importance of the message. Must be 'low', 'normal', or 'high'.",
        show=False,
        value="normal",
        advanced=True
    ),
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_cc_recipients",
        display_name="CC",
        info="List of CC recipients comma separated.",
        show=False,
        advanced=True
    ),
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_bcc_recipients",
        display_name="BCC",
        info="List of BCC recipients comma separated.",
        show=False,
        advanced=True
    ),
    MessageTextInput(
        name="OUTLOOK_OUTLOOK_UPDATE_EMAIL_to_recipients",
        display_name="To",
        info="List of TO recipients comma separated.",
        show=False,
    ),
    MessageTextInput(
    ...
    MessageTextInput(
        ...
        info="A list of attendee information. Only email is required for each attendee., Example: [{ 'email': 'team@example.com', 'name': 'Team', 'type': 'required' }, { 'email': 'other@example.com', 'type': 'optional' }, { 'email': 'other2@example.com' }]",
        show=False,
    ),
    MessageTextInput(
    ...
    MessageTextInput(
        ...
        display_name="User Id",
        info="The target user's email address or 'me' for the authenticated user. For delegated access scenarios, this should be the email of the shared mailbox or delegated user.",
        show=False,
        value="me",
        advanced=True
    ),
    ...
    MessageTextInput(
        ...
        info="Filter messages with a receivedDateTime greater than the specified value. Example: '2023-01-01T00:00:00Z'.",
        show=False,
        advanced=True
    ),
    MessageTextInput(
    ...
    MessageTextInput(
        ...
        display_name="Select",
        info="A list of properties to include in the response comma separated. Common properties: 'subject', 'from', 'toRecipients', 'receivedDateTime'.",
        show=False,
        advanced=True
    ),
    MessageTextInput(
    ...
    def execute_action(self):
        ...
        try:
            ...
            if action_key == "OUTLOOK_OUTLOOK_SEND_EMAIL" or action_key == "OUTLOOK_OUTLOOK_REPLY_EMAIL":
