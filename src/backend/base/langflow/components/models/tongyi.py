...
from langflow.base.models.tongyi_constants import TONGYI_MODEL_NAMES
...
class TongyiModelComponent(LCModelComponent):
    display_name = "Tongyi"
    description = "Generates text using Tongyi LLMs."
    icon = "Tongyi"
    name = "TongyiModel"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        DropdownInput(
            ...
            advanced=False,
            options=TONGYI_MODEL_NAMES,
            value=TONGYI_MODEL_NAMES[0],
        ),
        StrInput(
        ...
        SecretStrInput(
            name="api_key",
            display_name="Tongyi API Key",
            info="The Tongyi API Key to use for the Tongyi model.",
            advanced=False,
    ...
    def _get_exception_message(self, e: Exception):
        """Get a message from an Tongyi exception.
