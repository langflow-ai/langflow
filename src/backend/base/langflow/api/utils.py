...
from langflow.services.auth.utils import get_current_active_user, get_current_active_user_mcp, get_current_user_flexible
...
CurrentActiveUserFlexible = Annotated[User, Depends(get_current_user_flexible)]
