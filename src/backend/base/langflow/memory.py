...
def get_messages(
    ...
    agentops.record_event('messages_retrieved', {
...
def add_messages(messages: Message | list[Message], flow_id: str | None = None):
    ...
    try:
        ...
        agentops.record_event('messages_added', {
...
def delete_messages(session_id: str):
    ...
    agentops.record_event('messages_deleted', {
        'session_id': session_id,
...
def store_message(
    ...
    agentops.record_event('message_stored', {
...
class LCBuiltinChatMemory(BaseChatMessageHistory):
    ...
    def add_messages(self, messages: Sequence[BaseMessage]) -> None:
        ...
        agentops.record_event('chat_messages_added', {
            'count': len(messages),
    ...
    def clear(self) -> None:
        ...
        agentops.record_event('chat_memory_cleared', {
            'flow_id': self.flow_id,
            'session_id': self.session_id,
        })
