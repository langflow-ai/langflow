...
def _truncate_value(value: Any, max_length: int | None, max_items: int | None) -> Any:
    ...
    if max_length is not None and value_type is str and len(value) > max_length:
        return value[:max_length]

    if max_items is not None and (value_type is list or value_type is tuple) and len(value) > max_items:
