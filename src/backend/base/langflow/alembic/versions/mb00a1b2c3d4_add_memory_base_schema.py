...
def upgrade() -> None:
    ...
    if not migration.table_exists("memory_base_session", conn):
        op.create_table(
            "memory_base_session",
            sa.Column("id", sa.Uuid(), nullable=False),
            sa.Column("memory_base_id", sa.Uuid(), nullable=False),
            ...
            sa.ForeignKeyConstraint(
                ["memory_base_id"],
                ["memory_base.id"],
                name="fk_memory_base_session_memory_base_id_memory_base",
                ondelete="CASCADE",
            ),
            sa.PrimaryKeyConstraint("id"),
    ...
    if not migration.table_exists("message_ingestion_record", conn):
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["message_id"],
                ["message.id"],
                name="fk_message_ingestion_record_message_id_message",
                ondelete="CASCADE",
            ),
            sa.ForeignKeyConstraint(
                ["memory_base_id"],
                ["memory_base.id"],
                name="fk_message_ingestion_record_memory_base_id_memory_base",
                ondelete="CASCADE",
            ),
            sa.ForeignKeyConstraint(
                ["job_id"],
                ["job.job_id"],
                name="fk_message_ingestion_record_job_id_job",
                ondelete="SET NULL",
            ),
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint(
    ...
    if not migration.table_exists("memory_base_workflow_run", conn):
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["memory_base_id"],
                ["memory_base.id"],
                name="fk_memory_base_workflow_run_memory_base_id_memory_base",
                ondelete="CASCADE",
            ),
            sa.ForeignKeyConstraint(
                ["workflow_job_id"],
                ["job.job_id"],
                name="fk_memory_base_workflow_run_workflow_job_id_job",
                ondelete="SET NULL",
            ),
            sa.ForeignKeyConstraint(
                ["ingestion_job_id"],
                ["job.job_id"],
                name="fk_memory_base_workflow_run_ingestion_job_id_job",
                ondelete="SET NULL",
            ),
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint(
