...
revision: str = "0882f9657f22"  # pragma: allowlist secret
down_revision: str | None = "1cb603706752"  # pragma: allowlist secret
        ...
        for row in result:
            ...
            if auth_settings:
                try:
                    ...
                    # Migration script - print is acceptable here
                    print(f"Warning: Failed to encrypt auth_settings for folder {folder_id}: {e}")  # noqa: T201
        ...
        for row in result:
            ...
            if auth_settings:
                try:
                    ...
                    # Log the error but continue with other records
                    # Migration script - print is acceptable here
                    print(f"Warning: Failed to decrypt auth_settings for folder {folder_id}: {e}")  # noqa: T201
