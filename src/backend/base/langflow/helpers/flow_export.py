...
from components.MCP_Connection_Agent_Platform_yenDh import AgentPlatformMCPConnection as _MCP_Connection_Agent_Platform_yenDh
...
from components.MCP_Connection_Agent_Platform_05d3E import AgentPlatformMCPConnection as _MCP_Connection_Agent_Platform_05d3E
from components.MCP_Connection_Agent_Platform_v2Dkx import AgentPlatformMCPConnection as _MCP_Connection_Agent_Platform_v2Dkx
...
async def run(
    ...
    await set_component_inputs_and_run(
        components['MCP_Connection_Agent_Platform_yenDh'],
        {
            ...
            'tool': '',
            'tool_placeholder': '',
            'tools_metadata': [{'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read and return the contents of a text file.', 'display_description': 'Read and return the contents of a text file.', 'display_name': 'read_file', 'name': 'read_file', 'readonly': False, 'status': False, 'tags': ['read_file']}, {'args': {'dest': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': '.', 'title': 'Dest'}, 'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Extract a ZIP archive.', 'display_description': 'Extract a ZIP archive.', 'display_name': 'extract_zip', 'name': 'extract_zip', 'readonly': False, 'status': False, 'tags': ['extract_zip']}, {'args': {'dest': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': '.', 'title': 'Dest'}, 'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Extract a TAR archive.', 'display_description': 'Extract a TAR archive.', 'display_name': 'extract_tar', 'name': 'extract_tar', 'readonly': False, 'status': False, 'tags': ['extract_tar']}, {'args': {'dest': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': '.', 'title': 'Dest'}, 'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Extract a RAR archive.', 'display_description': 'Extract a RAR archive.', 'display_name': 'extract_rar', 'name': 'extract_rar', 'readonly': False, 'status': False, 'tags': ['extract_rar']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read and return text from a PDF file.', 'display_description': 'Read and return text from a PDF file.', 'display_name': 'read_pdf', 'name': 'read_pdf', 'readonly': False, 'status': False, 'tags': ['read_pdf']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read and return text from a Word (.docx) file.', 'display_description': 'Read and return text from a Word (.docx) file.', 'display_name': 'read_docx', 'name': 'read_docx', 'readonly': False, 'status': False, 'tags': ['read_docx']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read a CSV file and return its contents as a list of dictionaries.', 'display_description': 'Read a CSV file and return its contents as a list of dictionaries.', 'display_name': 'read_csv', 'name': 'read_csv', 'readonly': False, 'status': False, 'tags': ['read_csv']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read an Excel file and return its contents as a list of dictionaries.', 'display_description': 'Read an Excel file and return its contents as a list of dictionaries.', 'display_name': 'read_excel', 'name': 'read_excel', 'readonly': False, 'status': False, 'tags': ['read_excel']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read a JSON file and return its contents.', 'display_description': 'Read a JSON file and return its contents.', 'display_name': 'read_json', 'name': 'read_json', 'readonly': False, 'status': False, 'tags': ['read_json']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read a YAML file and return its contents.', 'display_description': 'Read a YAML file and return its contents.', 'display_name': 'read_yaml', 'name': 'read_yaml', 'readonly': False, 'status': False, 'tags': ['read_yaml']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read an INI file and return its contents.', 'display_description': 'Read an INI file and return its contents.', 'display_name': 'read_ini', 'name': 'read_ini', 'readonly': False, 'status': False, 'tags': ['read_ini']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read an XML file and return its contents.', 'display_description': 'Read an XML file and return its contents.', 'display_name': 'read_xml', 'name': 'read_xml', 'readonly': False, 'status': False, 'tags': ['read_xml']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read a Markdown file and return its contents.', 'display_description': 'Read a Markdown file and return its contents.', 'display_name': 'read_markdown', 'name': 'read_markdown', 'readonly': False, 'status': False, 'tags': ['read_markdown']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read an HTML file and return its contents.', 'display_description': 'Read an HTML file and return its contents.', 'display_name': 'read_html', 'name': 'read_html', 'readonly': False, 'status': False, 'tags': ['read_html']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read an audio file and return its metadata.', 'display_description': 'Read an audio file and return its metadata.', 'display_name': 'read_audio_metadata', 'name': 'read_audio_metadata', 'readonly': False, 'status': False, 'tags': ['read_audio_metadata']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Read a video file and return its metadata.', 'display_description': 'Read a video file and return its metadata.', 'display_name': 'read_video_metadata', 'name': 'read_video_metadata', 'readonly': False, 'status': False, 'tags': ['read_video_metadata']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'Return basic information about a file.', 'display_description': 'Return basic information about a file.', 'display_name': 'file_info', 'name': 'file_info', 'readonly': False, 'status': False, 'tags': ['file_info']}, {'args': {'path': {'title': 'Path', 'type': 'string'}}, 'description': 'List the contents of a directory.', 'display_description': 'List the contents of a directory.', 'display_name': 'list_directory', 'name': 'list_directory', 'readonly': False, 'status': False, 'tags': ['list_directory']}, {'args': {}, 'description': 'Create And Get the temporary directory.', 'display_description': 'Create And Get the temporary directory.', 'display_name': 'get_tmp_dir', 'name': 'get_tmp_dir', 'readonly': False, 'status': False, 'tags': ['get_tmp_dir']}, {'args': {'local_tz_override': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': None, 'title': 'Local Tz Override'}}, 'description': '', 'display_description': '', 'display_name': 'get_local_tz', 'name': 'get_local_tz', 'readonly': False, 'status': False, 'tags': ['get_local_tz']}, {'args': {'timezone_name': {'title': 'Timezone Name', 'type': 'string'}}, 'description': '', 'display_description': '', 'display_name': 'get_zoneinfo', 'name': 'get_zoneinfo', 'readonly': False, 'status': False, 'tags': ['get_zoneinfo']}, {'args': {'timezone_name': {'title': 'Timezone Name', 'type': 'string'}}, 'description': '', 'display_description': '', 'display_name': 'get_current_time_by_tz', 'name': 'get_current_time_by_tz', 'readonly': False, 'status': False, 'tags': ['get_current_time_by_tz']}, {'args': {'timezone_name': {'title': 'Timezone Name', 'type': 'string'}}, 'description': '\nGet the current time in a specified timezone.\n\nThis function retrieves the current date and time for a given timezone using\nthe `ZoneInfo` module. It also determines whether the current time is in\ndaylight saving time (DST).\n\nArgs:\n    timezone_name (str): The name of the timezone (e.g., "UTC", "America/New_York").\n\nReturns:\n    TimeResult: An object containing:\n        - timezone (str): The name of the timezone.\n        - datetime (str): The current date and time in ISO 8601 format (to seconds).\n        - is_dst (bool): Whether the current time is in daylight saving time (DST).\n', 'display_description': '\nGet the current time in a specified timezone.\n\nThis function retrieves the current date and time for a given timezone using\nthe `ZoneInfo` module. It also determines whether the current time is in\ndaylight saving time (DST).\n\nArgs:\n    timezone_name (str): The name of the timezone (e.g., "UTC", "America/New_York").\n\nReturns:\n    TimeResult: An object containing:\n        - timezone (str): The name of the timezone.\n        - datetime (str): The current date and time in ISO 8601 format (to seconds).\n        - is_dst (bool): Whether the current time is in daylight saving time (DST).\n', 'display_name': 'get_current_time', 'name': 'get_current_time', 'readonly': False, 'status': True, 'tags': ['get_current_time']}, {'args': {'source_tz': {'title': 'Source Tz', 'type': 'string'}, 'target_tz': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': 'UTC', 'title': 'Target Tz'}, 'time_str': {'title': 'Time Str', 'type': 'string'}}, 'description': '\nConverts a given datetime string from a source timezone to a target timezone.\n\nArgs:\n    source_tz (str): The IANA name of the source timezone (e.g., "Asia/Jerusalem").\n    time_str (str): The time string in "%Y-%m-%dT%H:%M:%S" format (e.g., "2025-04-16T15:00:00").\n    target_tz (str, optional): The IANA name of the target timezone. Defaults to "UTC".\n\nReturns:\n    TimeConversionResult: A structured object containing the converted time in both source and target timezones,\n                          DST info, and the time difference between them.\n', 'display_description': '\nConverts a given datetime string from a source timezone to a target timezone.\n\nArgs:\n    source_tz (str): The IANA name of the source timezone (e.g., "Asia/Jerusalem").\n    time_str (str): The time string in "%Y-%m-%dT%H:%M:%S" format (e.g., "2025-04-16T15:00:00").\n    target_tz (str, optional): The IANA name of the target timezone. Defaults to "UTC".\n\nReturns:\n    TimeConversionResult: A structured object containing the converted time in both source and target timezones,\n                          DST info, and the time difference between them.\n', 'display_name': 'convert_time_between_timezones', 'name': 'convert_time_between_timezones', 'readonly': False, 'status': True, 'tags': ['convert_time_between_timezones']}, {'args': {'delta_seconds': {'anyOf': [{'type': 'integer'}, {'type': 'null'}], 'default': 7200, 'title': 'Delta Seconds'}, 'time_format': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': '%Y-%m-%dT%H:%M:%S%z', 'title': 'Time Format'}, 'time_str': {'title': 'Time Str', 'type': 'string'}}, 'description': '\nGenerates a time window around a given timestamp.\n\nArgs:\n    time_str (str): The base timestamp as a string in time_format format (e.g., "2025-04-16T15:00:00+0000").\n    delta_seconds (int | str, optional): The number of seconds before and after the timestamp to include.\n                                           Default to 7200 (2 hours).\n    time_format (str, optional): The format of the input and output datetime strings.\n                                 Defaults to "%Y-%m-%dT%H:%M:%S%z".\n\nReturns:\n    Tuple[str, str]: A tuple of (start_time, end_time), both formatted according to time_format.\n', 'display_description': '\nGenerates a time window around a given timestamp.\n\nArgs:\n    time_str (str): The base timestamp as a string in time_format format (e.g., "2025-04-16T15:00:00+0000").\n    delta_seconds (int | str, optional): The number of seconds before and after the timestamp to include.\n                                           Default to 7200 (2 hours).\n    time_format (str, optional): The format of the input and output datetime strings.\n                                 Defaults to "%Y-%m-%dT%H:%M:%S%z".\n\nReturns:\n    Tuple[str, str]: A tuple of (start_time, end_time), both formatted according to time_format.\n', 'display_name': 'get_time_range_around_timestamp', 'name': 'get_time_range_around_timestamp', 'readonly': False, 'status': True, 'tags': ['get_time_range_around_timestamp']}, {'args': {'date_str': {'title': 'Date Str', 'type': 'string'}, 'output_format': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': '%Y-%m-%dT%H:%M:%S%z', 'title': 'Output Format'}, 'timezone': {'anyOf': [{'type': 'string'}, {'type': 'null'}], 'default': 'UTC', 'title': 'Timezone'}}, 'description': '\nConverts a date string into a full-day time range (00:00:00 to 23:59:59) in the specified timezone.\n\nArgs:\n    date_str (str): The date string in "%Y-%m-%d" format (e.g., "2025-04-16").\n    timezone (str, optional): The IANA timezone name. Defaults to "UTC".\n    output_format (str, optional): The format of the returned datetime strings.\n                                   Defaults to "%Y-%m-%dT%H:%M:%S%z".\n\nReturns:\n    Tuple[str, str]: A tuple of (start_of_day, end_of_day) in the specified timezone and format.\n', 'display_description': '\nConverts a date string into a full-day time range (00:00:00 to 23:59:59) in the specified timezone.\n\nArgs:\n    date_str (str): The date string in "%Y-%m-%d" format (e.g., "2025-04-16").\n    timezone (str, optional): The IANA timezone name. Defaults to "UTC".\n    output_format (str, optional): The format of the returned datetime strings.\n                                   Defaults to "%Y-%m-%dT%H:%M:%S%z".\n\nReturns:\n    Tuple[str, str]: A tuple of (start_of_day, end_of_day) in the specified timezone and format.\n', 'display_name': 'get_full_day_time_range_from_date', 'name': 'get_full_day_time_range_from_date', 'readonly': False, 'status': True, 'tags': ['get_full_day_time_range_from_date']}, {'args': {'text': {'title': 'Text', 'type': 'string'}}, 'description': 'Detect the language of a given text.', 'display_description': 'Detect the language of a given text.', 'display_name': 'detect_language', 'name': 'detect_language', 'readonly': False, 'status': True, 'tags': ['detect_language']}, {'args': {'app_name': {'title': 'App Name', 'type': 'string'}}, 'description': '\nCheck if the given name is a valid application.\n', 'display_description': '\nCheck if the given name is a valid application.\n', 'display_name': 'check_if_valid_application', 'name': 'check_if_valid_application', 'readonly': False, 'status': True, 'tags': ['check_if_valid_application']}],
            'input_value': flow_input or "",
        }
    )
    await set_component_inputs_and_run(
    ...
    await set_component_inputs_and_run(
        components['StructuredOutput_teP6p'],
        {
            ...
            'input_value': '',
            'multiple': True,
            'output_schema': [{'description': 'The EXACT & FULL comment argument from the input message', 'multiple': 'False', 'name': 'comment', 'type': 'str'}, {'description': 'The EXACT & FULL is_missing argument from the input message. If it is not provided, determine whether the comment indicates that the user is requesting missing data. ', 'name': 'is_missing', 'type': 'bool'}, {'description': '"MISSING_DATA" if is_missing is True, else "RESULT"', 'name': 'status', 'type': 'str'}],
            'schema_name': '',
    ...
    await set_component_inputs_and_run(
        components['StructuredOutput_3eYS1'],
        {
            ...
            'multiple': True,
            'output_schema': [{'description': 'The name of the user who reported the issue', 'multiple': 'False', 'name': 'reporter_user', 'type': 'str'}, {'description': 'The IP address from which the connection was initiated', 'name': 'source_ip', 'type': 'str'}, {'description': 'The target resource the user attempted to reach (url / ip address / application)', 'name': 'target_resource', 'type': 'str'}, {'description': 'The service name (e.g., HTTPS, SSH, FTP) OR the corresponding port number (e.g., 443, 22, 21) that the USER is trying to access', 'name': 'service', 'type': 'str'}, {'description': 'The time or time range when the user-reported issue occurred (latest provided), NOT the ticket creation time.', 'name': 'time_issue_happened', 'type': 'str'}, {'description': 'The timezone of the user who created the ticket, if not provided, set as "UNKNOWN"', 'name': 'timezone', 'type': 'str'}, {'description': 'Any error output the user received during the failed connection attempt', 'name': 'error_message', 'type': 'str'}, {'description': 'Detect the user’s language from the ticket comments. If unclear, set English', 'name': 'user_language', 'type': 'str'}, {'description': 'The name of the user who experienced the issue', 'name': 'user_experienced_issue', 'type': 'str'}, {'description': 'comments part from the input ticket details', 'name': 'comments', 'type': 'str'}],
            'schema_name': '',
