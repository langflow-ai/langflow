...
OPENAI_MODELS_DETAILED = {
    ...
    "gpt-4o-mini": create_model_metadata(
        provider="OpenAI",
        name="gpt-4o-mini",
        icon="OpenAI",
        tool_calling=True
    ),
    "gpt-4o": create_model_metadata(
        provider="OpenAI",
        name="gpt-4o",
        icon="OpenAI",
        tool_calling=True
    ),
    "gpt-4.1": create_model_metadata(
        provider="OpenAI",
        name="gpt-4.1",
        icon="OpenAI",
        tool_calling=True
    ),
    "gpt-4.1-mini": create_model_metadata(
        provider="OpenAI",
        name="gpt-4.1-mini",
        icon="OpenAI",
        tool_calling=True
    ),
    "gpt-4.1-nano": create_model_metadata(
        provider="OpenAI",
        name="gpt-4.1-nano",
        icon="OpenAI",
        tool_calling=True
    ...
    "gpt-4-turbo": create_model_metadata(
        provider="OpenAI",
        name="gpt-4-turbo",
        icon="OpenAI",
        tool_calling=True
    ...
    "gpt-4": create_model_metadata(
        provider="OpenAI",
        name="gpt-4",
        icon="OpenAI",
        tool_calling=True
    ),
    "gpt-3.5-turbo": create_model_metadata(
        provider="OpenAI",
        name="gpt-3.5-turbo",
        icon="OpenAI",
        tool_calling=True
...
OPENAI_MODEL_NAMES = [
    model for model, metadata in OPENAI_MODELS_DETAILED.items()
    if not metadata.get('reasoning', False) and not metadata.get('search', False) and not metadata.get('not_supported', False)
]
