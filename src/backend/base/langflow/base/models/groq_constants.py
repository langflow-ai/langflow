...
GROQ_PRODUCTION_MODELS = [
    model_name
    for model_name, metadata in GROQ_MODELS_DETAILED.items()
...
GROQ_PREVIEW_MODELS = [
    model_name for model_name, metadata in GROQ_MODELS_DETAILED.items() if metadata.get("preview", False)
]

DEPRECATED_GROQ_MODELS = [
    model_name for model_name, metadata in GROQ_MODELS_DETAILED.items() if metadata.get("deprecated", False)
]

UNSUPPORTED_GROQ_MODELS = [
    model_name for model_name, metadata in GROQ_MODELS_DETAILED.items() if metadata.get("not_supported", False)
]
