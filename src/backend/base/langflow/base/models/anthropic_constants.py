...
ANTHROPIC_MODELS_DETAILED = {
    ...
    "claude-2.1": create_model_metadata(
        provider="Anthropic",
        name="claude-2.1",
        icon="Anthropic",
        tool_calling=False
    ),
    "claude-2.0": create_model_metadata(
        provider="Anthropic", 
        name="claude-2.0",
        icon="Anthropic",
        tool_calling=False
