...
MAX_SESSIONS_PER_SERVER = 10  # Maximum number of sessions per server to prevent resource exhaustion
SESSION_IDLE_TIMEOUT = 400  # 5 minutes idle timeout for sessions
SESSION_CLEANUP_INTERVAL = 120  # Cleanup interval in seconds
