...
from langflow.logs.logger import configure, logger
...
def build_version_notice(current_version: str, package_name: str) -> str:
    ...
    """
    with suppress(httpx.ConnectError, InvalidVersion):
...
if __name__ == "__main__":
    # Run the `run` function with default values
