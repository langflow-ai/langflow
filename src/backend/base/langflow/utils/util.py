...
async def update_settings(
    *,
    ...
    webhook_pooling_interval: int = 5000,
) -> None:
    ...
    if webhook_pooling_interval is not None:
        logger.debug(f"Setting webhook_pooling_interval to {webhook_pooling_interval}")
        settings_service.settings.update_settings(webhook_pooling_interval=webhook_pooling_interval)
