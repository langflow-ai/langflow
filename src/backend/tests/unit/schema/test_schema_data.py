...
class TestDataSchema:
    def test_data_to_message_with_text_only(self):
        ...
        data = JSON(data={"text": "Hello, world!", "sender": MESSAGE_SENDER_USER})
    ...
    def test_data_to_message_with_image(self, sample_image):
        ...
        data = JSON(data={"text": "Check out this image", "sender": MESSAGE_SENDER_USER, "files": [str(sample_image)]})
        message = data.to_lc_message()
    ...
    def test_data_to_message_ai_response(self):
        ...
        data = JSON(data={"text": "AI response", "sender": MESSAGE_SENDER_AI})
        message = data.to_lc_message()
    ...
    def test_data_to_message_missing_required_keys(self):
        ...
        data = JSON(data={"incomplete": "data"})
    ...
    def test_data_to_message_invalid_image_path(self, tmp_path):
        ...
        data = JSON(data={"text": "Invalid image", "sender": MESSAGE_SENDER_USER, "files": [str(non_existent_image)]})
