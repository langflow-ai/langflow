...
def test_vector_store_rag():
    ...
    vector_store.set(embeddings=openai_embeddings.build_embeddings, ingest_data=text_splitter.split_text)
    ...
    rag_vector_store.set(search_input=chat_input.message_response)
