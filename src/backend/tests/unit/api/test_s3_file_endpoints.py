...
from langflow.api.v2.files import router
    ...
    async def test_s3_download_file_content(self, s3_storage_service, s3_settings):
        ...
        with (
            ...
            with (
                ...
                s3_storage_service.get_file.assert_called_once_with(
                    flow_id="user_123",
                    file_name="document.pdf"
                )
    ...
    async def test_s3_delete_file(self, s3_storage_service, s3_settings):
        ...
        with (
            ...
            with (
                ...
                s3_storage_service.delete_file.assert_called_once_with(
                    flow_id="user_123",
                    file_name="document.pdf"
                )
    ...
    async def test_s3_file_size_calculation(self, s3_storage_service, s3_settings):
        ...
        with (
            ...
            with (
                ...
                s3_storage_service.get_file_size.assert_called_once_with(
                    flow_id="user_123",
                    file_name="test.txt"
                )
