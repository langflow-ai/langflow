...
@pytest.mark.usefixtures("active_user")
async def test_get_model_provider_credentials(client: AsyncClient, openai_credential, anthropic_credential, logged_in_headers):
...
@pytest.mark.usefixtures("active_user")
async def test_get_model_provider_credentials_filter_by_provider(client: AsyncClient, openai_credential, anthropic_credential, logged_in_headers):
...
async def test_get_model_provider_credential_by_id(client: AsyncClient, openai_credential, logged_in_headers):
    ...
    # Create a credential
    create_response = await client.post("api/v1/model-provider-credentials/", json=openai_credential, headers=logged_in_headers)
...
@pytest.mark.usefixtures("active_user")
async def test_get_model_provider_credentials_by_provider(client: AsyncClient, openai_credential, anthropic_credential, logged_in_headers):
...
async def test_create_credential_with_special_characters(client: AsyncClient, logged_in_headers):
    ...
    response = await client.post("api/v1/model-provider-credentials/", json=special_credential, headers=logged_in_headers)
    result = response.json()
