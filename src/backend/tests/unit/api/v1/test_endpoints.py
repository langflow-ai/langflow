...
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_no_payload(client, simple_api_test, created_api_key, flow_id_type):
    headers = {"x-api-key": created_api_key.api_key}
    flow_id = simple_api_test[flow_id_type]
...
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_with_output_type_text(client, simple_api_test, created_api_key, flow_id_type):
    headers = {"x-api-key": created_api_key.api_key}
    flow_id = simple_api_test[flow_id_type]
    payload = {
        "output_type": "text",
...
@pytest.mark.benchmark
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_with_output_type_any(client, simple_api_test, created_api_key, flow_id_type):
...
@pytest.mark.benchmark
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_with_output_type_debug(client, simple_api_test, created_api_key, flow_id_type):
...
@pytest.mark.benchmark
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_with_input_type_text(client, simple_api_test, created_api_key, flow_id_type):
    headers = {"x-api-key": created_api_key.api_key}
    flow_id = simple_api_test[flow_id_type]
    payload = {
        "input_type": "text",
...
@pytest.mark.benchmark
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_with_input_type_chat(client: AsyncClient, simple_api_test, created_api_key, flow_id_type):
    headers = {"x-api-key": created_api_key.api_key}
    flow_id = simple_api_test[flow_id_type]
    payload = {
        "input_type": "chat",
...
@pytest.mark.benchmark
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_invalid_run_with_input_type_chat(client, simple_api_test, created_api_key, flow_id_type):
    headers = {"x-api-key": created_api_key.api_key}
    flow_id = simple_api_test[flow_id_type]
    payload = {
        "input_type": "chat",
...
@pytest.mark.benchmark
@pytest.mark.parametrize("flow_id_type", ["id", "endpoint_name"])
async def test_successful_run_with_input_type_any(client, simple_api_test, created_api_key, flow_id_type):
    headers = {"x-api-key": created_api_key.api_key}
    flow_id = simple_api_test[flow_id_type]
    payload = {
        "input_type": "any",
...
@pytest.mark.parametrize("flow_id", ["invalid-flow-id", UUID(int=0)])
async def test_invalid_flow_id(client, created_api_key, flow_id):
    headers = {"x-api-key": created_api_key.api_key}
    response = await client.post(f"/api/v1/run/{flow_id}", headers=headers)
...
@pytest.mark.api_key_required
@pytest.mark.benchmark
@pytest.mark.parametrize("num_concurrent_requests", [5])
async def test_concurrent_stream_run_with_input_type_chat(
    client: AsyncClient, starter_project, created_api_key, num_concurrent_requests
):
