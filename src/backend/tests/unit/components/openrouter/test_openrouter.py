...
class TestOpenRouterComponent(ComponentTestBaseWithoutClient):
    ...
    async def test_build_model(self, mock_chat_openai, component_class, default_kwargs):
        ...
        mock_chat_openai.assert_called_once_with(
            ...
            temperature=0.7,
            max_tokens=1000,
            default_headers={"HTTP-Referer": "https://example.com", "X-Title": "Test App"},
        )
    ...
    async def test_build_model_minimal_config(self, mock_chat_openai, component_class):
        ...
        component = component_class(api_key="test-api-key", model_name="openai/gpt-4", provider="OpenAI")
        model = component.build_model()
    ...
    async def test_build_model_no_api_key(self, component_class):
        ...
        component = component_class(model_name="openai/gpt-4", provider="OpenAI")
    ...
    async def test_build_model_no_model_selected(self, component_class):
        ...
        component = component_class(api_key="test-api-key", model_name="Select a provider first")
    ...
    async def test_fetch_models_success(self, mock_client_class, component_class, default_kwargs):
        ...
        mock_response.json.return_value = {
            "data": [
                {"id": "openai/gpt-4", "name": "GPT-4", "description": "OpenAI's GPT-4 model", "context_length": 8192},
                {
    ...
    def test_component_inputs(self, component_class):
        ...
        expected_inputs = ["api_key", "site_url", "app_name", "provider", "model_name", "temperature", "max_tokens"]
