...
The facade's scaled stop_job writes the durable ExecutionSignal(STOP) (the source
of truth) AND publishes the redis pub/sub fast-path. The worker's JobRunner polls
