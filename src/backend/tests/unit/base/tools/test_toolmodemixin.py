...
class AllInputsComponent(Component):
    ...
    def build_output(self) -> Data:
        ...
        data_dict= {"table_input": self.table_input,
...
async def test_component_inputs_toolkit():
    ...
    expected_inputs = {
        "table_input": {
            "title": "Table Input",
            "description": "Input for table data."
        },
        "data_input": {
            "title": "Data Input",
            "description": "Input for data objects."
        },
        "dataframe_input": {
        ...
        "str_input": {
            "title": "Str Input",
            "description": "Input for string data."
        },
        "message_input": {
            "title": "Message Input",
        ...
        "int_input": {
            "title": "Int Input",
            "description": "Input for integer values."
        },
        "float_input": {
            "title": "Float Input",
    ...
    for input_name, expected in expected_inputs.items():
        ...
        assert properties[input_name]["description"] == expected["description"], f"Description mismatch for {input_name}."
