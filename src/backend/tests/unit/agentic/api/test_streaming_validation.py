"""Tests for streaming validation flow in the agentic router.
...
import pytest
from langflow.agentic.api.router import (
...
class TestSSEEventFormatting:
    ...
    def test_sse_progress_format(self):
        ...
        result = _sse_progress("generating", 1, 4)
    ...
    def test_sse_progress_validating_step(self):
        """Should format validating progress event correctly."""
        result = _sse_progress("validating", 2, 4)
    ...
    def test_sse_complete_format(self):
        ...
        result = _sse_complete(test_data)
    ...
    def test_sse_error_format(self):
        ...
        result = _sse_error("Rate limit exceeded")
...
class TestStreamingValidationFlow:
    ...
    async def test_valid_code_first_try_returns_validated(self):
        ...
        with patch(
            "langflow.agentic.api.router.execute_flow_file",
    ...
    @pytest.mark.asyncio
    async def test_flow_execution_error_returns_sse_error(self):
