...
class ToolNode(LangChainNode):
    def __init__(self, data: Dict):
        super().__init__(data, base_type="tools")


class PromptNode(LangChainNode):
    def __init__(self, data: Dict):
...
class LLMNode(LangChainNode):
    def __init__(self, data: Dict):
        super().__init__(data, base_type="llms")


class ToolkitNode(LangChainNode):
    def __init__(self, data: Dict):
...
class WrapperNode(LangChainNode):
    def __init__(self, data: Dict):
...
class DocumentLoaderNode(LangChainNode):
    def __init__(self, data: Dict):
...
class VectorStoreNode(LangChainNode):
    def __init__(self, data: Dict):
