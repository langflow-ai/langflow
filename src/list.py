...
def list_chains():
    ...
    return list(chains.loading.type_to_loader_dict.keys())
...
def list_prompts():
    ...
    return list(prompts.loading.type_to_loader_dict.keys())


@router.get("/llms")
def list_llms():
    """List all llm types"""
    return list(llms.type_to_cls_dict.keys())


@router.get("/memories")
def list_memories():
    """List all memory types"""
    return list(memories.type_to_cls_dict.keys())
