...
from lfx.projects.flow_slots import ProjectFlowBindings, binding_outputs, remap_runtime_bindings
from lfx.projects.hooks import HOOK_ORIGIN, compose_hooks, validate_hook_binding
...
def test_import_remaps_runtime_and_origin_together():
    ...
    remap_runtime_bindings(
        {"agent": agent, "source": source}, {"agent": "new-agent", "source": "new-source"}, "new-project"
    )
