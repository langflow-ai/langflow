...
# Keep the clean-flow gate regression aligned with the autogenerated current starter.
# Versioned fixtures intentionally preserve old component source for migration tests.
_CURRENT_BASIC_PROMPTING = (
...
def test_check_defaults_to_bundled_registry_for_clean_flow():
    """End-to-end regression: the current clean starter flow must PASS --upgrade-flow=check.
    ...
    """
    raw = json.loads(_CURRENT_BASIC_PROMPTING.read_text(encoding="utf-8"))
