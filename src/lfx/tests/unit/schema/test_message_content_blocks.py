...
class TestBackwardsCompatibility:
    ...
    def test_error_message_renders_reason_coded_exception_message(self):
        ...
        class ReasonCodedError(Exception):
            code = "policy_blocked"

        exc = ReasonCodedError("The selected model is blocked by policy.")
        ...
        assert "ReasonCodedError" not in error_content.reason
    ...
    def test_error_message_shows_the_text_of_a_driver_exception_that_carries_a_code(self):
        """A coded driver error must not collapse to its numeric code.
