...
"""Mirrors lfx.extension.manifest._BUNDLE_NAME_RE so we can derive a
syntactically-valid bundle name from the directory name without importing
a private regex.  Drift here is caught by the AC test which round-trips
init -> validate."""
