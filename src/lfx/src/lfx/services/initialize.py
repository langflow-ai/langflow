...
# MEAS-03 landmark (D-03a). Records `after-initialize-services` exactly once, the first time
# this module is imported. No-op unless LFX_BENCHMARK_CHECKPOINTS is set. See `lfx/_bench.py`.
