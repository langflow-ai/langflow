...
class ExtensionEventsService(Service):
    ...
    Keyspaces:
    - "global": system-wide events (bundle_reloaded, bundle_reload_failed).
    - "session:<id>": reserved for user-scoped events (not used in Phase 1).
    Phase 1 emits everything to "global"; flow_id is carried in the payload.
    """
