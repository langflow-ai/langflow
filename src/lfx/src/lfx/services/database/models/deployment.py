...
from lfx.services.database.utils import validate_non_empty_string, validate_non_empty_string_preserve_value

if TYPE_CHECKING:
    from lfx.services.database.models.deployment_provider_account import DeploymentProviderAccount
