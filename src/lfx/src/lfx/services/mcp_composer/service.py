        ...
        *,
        ...
        if auth_config:
            ...
            if auth_type == "oauth":
                ...
                if "oauth_callback_url" not in auth_config or not auth_config.get("oauth_callback_url"):
                    if "oauth_callback_path" in auth_config and auth_config.get("oauth_callback_path"):
