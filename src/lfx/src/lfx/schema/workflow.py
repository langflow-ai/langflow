...
class WorkflowExecutionRequest(BaseModel):
    ...
    inputs: dict[str, Any] | None = Field(
        None,
        description="Inputs with 'global' key for global inputs and component IDs for component-specific tweaks"
    )
...
WORKFLOW_STATUS_RESPONSES = {
    200: {
        ...
        "content": {
            "application/json": {
                "schema": WorkflowExecutionResponse.model_json_schema()
            },
            "text/event-stream": {
                "schema": WorkflowStreamEvent.model_json_schema(),
