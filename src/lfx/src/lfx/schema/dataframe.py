...
class Table(pandas_DataFrame):
    ...
    This is the new base type for Langflow tabular data structures, replacing DataFrame.
    DataFrame is maintained for backwards compatibility and is an alias to Table.
