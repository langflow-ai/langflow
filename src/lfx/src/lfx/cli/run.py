...
from lfx.cli.common import create_verbose_printer
...
async def run(
    ...
    *,
    ...
    # Create verbose_print function for component checking
    verbose_print = create_verbose_printer(verbose=verbosity > 0)
