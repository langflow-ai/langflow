...
class RequestyComponent(LCModelComponent):
    """Requesty API component for language models."""

    display_name = "Requesty"
    description = (
        "Requesty provides unified access to multiple AI models from different providers through a single API."
    )
    icon = "Requesty"
