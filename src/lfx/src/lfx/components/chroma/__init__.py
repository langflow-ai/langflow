# lfx-bundles-shim
"""Compatibility shim: lfx.components.chroma moved to lfx-bundles.
...
try:
    ...
    if exc.name is not None and (exc.name == "lfx_bundles" or exc.name.startswith("lfx_bundles.")):
        msg = (
            "The 'chroma' components moved to the 'lfx-bundles' distribution. Install it with: pip install lfx-bundles."
        )
