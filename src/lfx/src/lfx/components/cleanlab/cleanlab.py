...
class Cleanlab(Component):
    ...
    inputs = [
        ...
        DropdownInput(
            ...
            options=["best", "high", "medium", "low", "base"],
            value="best",
            info="The quality preset to use for validation.",
            required=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="Optional system instructions to prepend as the first message.",
            required=False,
        ),
        MessageTextInput(
            name="input_text",
            display_name="Input",
            info="The user input message (added as the user message in validate).",
            required=True,
        ),
        MessageTextInput(
            name="query",
            display_name="User Query",
            info="The user's core query (latest user message).",
            required=True,
        ),
        MessageTextInput(
            name="response",
            display_name="Response",
            info="The response generated by your RAG system.",
            required=True,
        ),
        MessageTextInput(
            name="context",
