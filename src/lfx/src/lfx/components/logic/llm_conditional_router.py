...
class LLMConditionalRouterComponent(Component):
            ...
            table_schema=[
                {
                    ...
                    "type": "str",
                    "description": "Name for the output (used for output name)",
                },
        ...
        if field_name == "categories":
            ...
            for i, row in enumerate(field_value):
                ...
                frontend_node["outputs"].append(
                    Output(
                        display_name=label, name=f"category_{i + 1}_result", method="process_case", group_outputs="True"
                    )
                )
    ...
    def process_case(self) -> Message:
        ...
        if llm and categories:
            ...
            category_values = [
                category.get("value", category.get("label", f"Category {i + 1}"))
...
Category:"""
            ...
            try:
                ...
                for i, category in enumerate(categories):
                    ...
                    if (
                        categorization.lower() == category_value.lower()
                        or categorization.lower() == category_label.lower()
                    ):
                        matched_category = i
