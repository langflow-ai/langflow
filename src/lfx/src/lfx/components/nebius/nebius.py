...
class NebiusModelComponent(LCModelComponent):
    ...
    description = "Generates text using Nebius AI Studio LLMs (OpenAI compatible)."
    icon = "Nebius"
    name = "NebiusModel"
    ...
    inputs = [
        *LCModelComponent.get_base_inputs(),
        ...
        SecretStrInput(
            ...
            info="The Nebius API Key to use for Nebius AI models.",
            advanced=False,
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        ...
        try:
            ...
            msg = "Could not connect to Nebius API."
