...
class PubrioSearchVerticalCategoriesComponent(Component):
    display_name = "Pubrio Search Vertical Categories"
    description = "Search vertical categories by keyword."
    icon = "search"
    name = "PubrioSearchVerticalCategories"
    ...
    def search(self) -> DataFrame:
        result = pubrio_post(self.api_key, "/verticals/categories", {"keyword": self.keyword})
