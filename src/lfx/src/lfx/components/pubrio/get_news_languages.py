...
class PubrioGetNewsLanguagesComponent(Component):
    display_name = "Pubrio Get News Languages"
    description = "Get all news language codes."
    icon = "list"
    name = "PubrioGetNewsLanguages"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/companies/news/languages")
