...
class PubrioGetLocationsComponent(Component):
    display_name = "Pubrio Get Locations"
    description = "Get all available location codes."
    icon = "list"
    name = "PubrioGetLocations"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/locations")
