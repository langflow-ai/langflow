...
class PubrioGetTimezonesComponent(Component):
    display_name = "Pubrio Get Timezones"
    description = "Get all timezone codes."
    icon = "list"
    name = "PubrioGetTimezones"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/timezones")
