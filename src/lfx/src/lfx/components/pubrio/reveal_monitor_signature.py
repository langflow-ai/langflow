...
class PubrioRevealMonitorSignatureComponent(Component):
    display_name = "Pubrio Reveal Monitor Signature"
    description = "Reveal webhook signature secret for a monitor."
    icon = "activity"
    name = "PubrioRevealMonitorSignature"
    ...
    def run(self) -> DataFrame:
        result = pubrio_post(self.api_key, "/monitors/signature/reveal", {"monitor_id": self.monitor_id})
