...
class PubrioSearchVerticalSubCategoriesComponent(Component):
    display_name = "Pubrio Search Vertical Sub-Categories"
    description = "Search vertical sub-categories by keyword."
    icon = "search"
    name = "PubrioSearchVerticalSubCategories"
    ...
    def search(self) -> DataFrame:
        result = pubrio_post(self.api_key, "/verticals/sub_categories", {"keyword": self.keyword})
