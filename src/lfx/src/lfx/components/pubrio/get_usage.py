...
class PubrioGetUsageComponent(Component):
    display_name = "Pubrio Get Usage"
    description = "Get credit usage and subscription info."
    icon = "list"
    name = "PubrioGetUsage"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/profile/usage")
