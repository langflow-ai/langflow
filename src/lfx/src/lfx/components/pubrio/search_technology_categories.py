...
class PubrioSearchTechnologyCategoriesComponent(Component):
    display_name = "Pubrio Search Technology Categories"
    description = "Search technology categories by keyword."
    icon = "search"
    name = "PubrioSearchTechnologyCategories"
    ...
    def search(self) -> DataFrame:
        result = pubrio_post(self.api_key, "/technologies/categories", {"keyword": self.keyword})
