...
class PubrioGetMonitorLogDetailComponent(Component):
    display_name = "Pubrio Get Monitor Log Detail"
    description = "Get details of a specific log entry."
    icon = "activity"
    name = "PubrioGetMonitorLogDetail"
    ...
    def run(self) -> DataFrame:
        result = pubrio_post(self.api_key, "/monitors/statistics/logs/lookup", {"log_id": self.log_id})
