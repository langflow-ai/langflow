...
class PubrioGetDepartmentFunctionsComponent(Component):
    display_name = "Pubrio Get Department Functions"
    description = "Get all department function codes."
    icon = "list"
    name = "PubrioGetDepartmentFunctions"
    ...
    def fetch(self) -> DataFrame:
        result = pubrio_get(self.api_key, "/departments/function")
