...
class PubrioGetMonitorComponent(Component):
    display_name = "Pubrio Get Monitor"
    description = "Get details of a specific monitor."
    icon = "activity"
    name = "PubrioGetMonitor"
    ...
    def run(self) -> DataFrame:
        result = pubrio_post(self.api_key, "/monitors/lookup", {"monitor_id": self.monitor_id})
