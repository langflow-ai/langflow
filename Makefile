...
help_test: ## show testing commands
	...
	@echo "  $(GREEN)make test_frontend_playwright$(NC) - Run Playwright e2e tests"
	@echo "  $(GREEN)make test_frontend_playwright_coverage$(NC) - Run frontend Playwright e2e tests with coverage"
	@echo "  $(GREEN)make tests_frontend UI=true$(NC) - Run Playwright e2e tests with UI"
	@echo "  $(GREEN)make test_frontend_jest$(NC)        - Run Jest unit tests"
	@echo "  $(GREEN)make test_frontend_jest_watch$(NC)  - Run Jest tests in watch mode"
	@echo "  $(GREEN)make test_frontend_jest_coverage$(NC) - Run Jest with coverage"
	@echo "  $(GREEN)make test_frontend_jest_coverage_open$(NC) - Run Jest coverage and open report"
	@echo "  $(GREEN)make test_frontend_jest_verbose$(NC) - Run Jest tests with verbose output"
	@echo "  $(GREEN)make test_frontend_jest_ci$(NC)     - Run Jest tests in CI mode"
	@echo "  $(GREEN)make test_frontend_jest_clean$(NC)  - Clean cache and run Jest tests"
	@echo "  $(GREEN)make test_frontend_jest_bail$(NC)   - Run Jest tests with bail"
	@echo "  $(GREEN)make test_frontend_jest_silent$(NC) - Run Jest tests silently"
	@echo "  $(GREEN)make test_frontend_jest_file path$(NC) - Run Jest tests for specific file"
	@echo "  $(GREEN)make test_frontend_jest_pattern pattern$(NC) - Run Jest tests matching pattern"
	@echo "  $(GREEN)make test_frontend_jest_snapshots$(NC) - Update Jest snapshots"
	@echo "  $(GREEN)make test_frontend_jest_config$(NC) - Show Jest configuration"
	@echo "  $(GREEN)make test_frontend_combined_coverage$(NC) - Run both Jest and Playwright coverage report"
	@echo "  $(GREEN)make test_frontend_combined_coverage_open$(NC) - Run both Jest and Playwright coverage and open report"
	@echo ''
