...
def _get_distribution_version(import_name: str):
    try:
        ...
        return _get_distribution_version_by_distname(dist_name)
    except (ImportError, AttributeError, OSError, ValueError):
        return None


# Additional layer: cache per-dist version for fastest repeated lookup.
@lru_cache(maxsize=128)
def _get_distribution_version_by_distname(dist_name: str):
    try:
