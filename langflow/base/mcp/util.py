...
def _get_mcp_settings():
    ...
    if not hasattr(_get_mcp_settings, "_settings"):
        _get_mcp_settings._settings = get_settings_service().settings
    return _get_mcp_settings._settings
