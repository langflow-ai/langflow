...
def get_settings_service() -> SettingsService:
    ...
    """
    global _settings_service_factory
    if _settings_service_factory is None:
        from langflow.services.settings.factory import SettingsServiceFactory

        _settings_service_factory = SettingsServiceFactory()
    return get_service(ServiceType.SETTINGS_SERVICE, _settings_service_factory)
...
_settings_service_factory = None
