...
>
> **2026-09-17:** the pinned default below is now **100** (recursion_limit 205), and typing `/` in the composer lists `/skip-all`, `/history` and `/iterations` — see the 2026-09-17 revision and ADR-034 in [`langflow-assistant.md`](./langflow-assistant.md).
>
