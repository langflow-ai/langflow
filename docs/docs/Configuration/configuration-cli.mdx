...
To disable this command, set [`LANGFLOW_ENABLE_SUPERUSER_CLI=false`](./environment-variables.mdx#LANGFLOW_ENABLE_SUPERUSER_CLI).
For security reasons, this is recommended in production environments to prevent unauthorized superuser creation.
