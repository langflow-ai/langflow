...
| `LANGFLOW_FRONTEND_PATH` | String | Not set | Path to the frontend directory containing build files. This is for development purposes only. |
...
| `LANGFLOW_LANGCHAIN_CACHE` | String | `InMemoryCache` | Type of cache to use. Possible values: `InMemoryCache`, `SQLiteCache`. |
...
| `LANGFLOW_STORE` | Boolean | `true` | Enable the Langflow Store features. |
