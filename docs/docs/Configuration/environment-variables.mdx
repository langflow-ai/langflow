...
| `LANGFLOW_CORS_ALLOW_CREDENTIALS` | Boolean | True | See [Authentication variables](/api-keys-and-authentication#authentication-environment-variables). |
| `LANGFLOW_CORS_ALLOW_HEADERS` | List[String] or String | `*` | See [Authentication variables](/api-keys-and-authentication#authentication-environment-variables). |
| `LANGFLOW_CORS_ALLOW_METHODS` | List[String] or String | `*` | See [Authentication variables](/api-keys-and-authentication#authentication-environment-variables). |
| `LANGFLOW_CORS_ORIGINS` | String | `*` | See [Authentication variables](/api-keys-and-authentication#authentication-environment-variables). |
