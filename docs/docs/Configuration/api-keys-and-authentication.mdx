...
- Authentication cookies and authorization headers are sent with requests
- API requests can use either the `x-api-key` header or session-based authentication
