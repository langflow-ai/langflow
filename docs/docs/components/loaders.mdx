...
**Params**
- **metadata:** it refers to optional information associated with each document that is loaded from the College Confidential website. The metadata can be useful for organizing and categorizing the documents loaded from the website based on different criteria or attributes. Defaults to `{}`.
...
- **metadata:** is used to specify the metadata that you want to associate with the loaded documents. It is an optional parameter and should be an object representing the metadata.  Defaults to `{}`.
...
- **web_path:** is used to specify the path of the file to be loaded. It is a string that represents the file path, including the file name and extension.
```python
web_path = "https://www.gutenberg.org/cache/epub/71107/pg71107.txt"
```
- **metadata:** provides information about the source of the eBook and any additional details associated with it. In the case of the provided example, the metadata for the Gutenberg eBook includes the source URL of the eBook, which is 
```HTML
...
- **web_path:** initialize with webpage path from Hacker News. It is a string that represents the URL of the page.
...
- **metadata:** it provides additional information about a post or page. In the context of iFixit, metadata includes details such as the source URL, title, and other relevant information about the post or page. Defaults to `{}`.
...
- **metadata:** it provides additional information about a post or page. In the context of IMSDb, metadata includes details such as the source URL, title, and other relevant information about the post or page. Defaults to `{}`.

- **web_path:** is used to specify the URL of the webpage that contains the script from the IMSDb.
...
- **file_path:** is used to specify the path to the PDF file that you want to load. It is a string that represents the file path on your system where the PDF file is located.

- **metadata:** it refers to additional information associated with each document loaded from a PDF file. It provides details about the document, such as the page number, structure, and tags. Defaults to `{}`.
...
- **metadata:** it refers to additional information associated with the document loaded from a ReadTheDocs Documentation. Defaults to `{}`.
...
- **file_path:** is used to specify the path of the SRT file that you want to load. It is a string that represents the file path, including the file name and extension.

- **metadata:** is specific to the subtitle file and may not include additional metadata about the content of the subtitles themselves. Defaults to `{}`.
...
- **file_path:** it is used to identify the location of the file that contains the `.txt` data to be loaded.

- **metadata:** it refers to additional information associated with the document loaded from a text data. Defaults to `{}`.
...
- **metadata:** it refers to additional information associated with the document loaded from a email data. Defaults to `{}`.
...
- **file_path:** it is used to identify the location of the HMTL file in the file system.
- **metadata:** it refers to additional information associated with the document loaded from a HTML data. Defaults to `{}`.
...
- **file_path:** it is used to identify the location of the `md` file in the file system.
- **metadata:** it refers to additional information associated with the document loaded from a `md` data. Defaults to `{}`.
...
- **file_path:** it is used to identify the location of the `docx` file in the file system.

- **metadata:** it refers to additional information associated with the document loaded from a `docx` data. Defaults to `{}`.
...
- **web_path:** is used to load a sitemap from a given URL and scrape and load all pages in the sitemap.
