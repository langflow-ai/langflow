...
:::tip
As of Langflow 1.11.x, the `ibm-watsonx-orchestrate-core` and `ibm-watsonx-orchestrate-clients` packages are upgraded to version 2.11 and are compatible with Python 3.14.
