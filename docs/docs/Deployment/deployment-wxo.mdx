...
6. In the **Attach Flows** pane, select a flow and flow version to deploy.
7. In the **Create Connections** pane, you can create a new connection or select an existing connection to bind to the flow.
