---
title: Deploy Langflow agents on watsonx Orchestrate
slug: /deployment-wxo
---
...
11. In your IBM watsonx Orchestrate deployment, navigate to **Agent Chat** > **Manage Agents**, and confirm that your Langflow flow is listed as an agent.
