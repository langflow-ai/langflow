...
2. Follow this link to deploy the Langflow template on Railway:
   ...
   [![Deploy on Railway](/logos/railway-deploy.svg)](https://railway.com/new/template/kit-langflow-build-0919?referralCode=MnPSdg&utm_medium=integration&utm_source=docs&utm_campaign=langflow)
