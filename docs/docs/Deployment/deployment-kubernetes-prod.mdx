...
This includes built-in [Langflow environment variables](/environment-variables), as well as [global variables](/configuation-global-variables) used by your flows.
...
* [Langflow best practices on Kubernetes](/deployment-prod-best-practices)
