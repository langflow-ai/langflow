...
3. Set `LANGFLOW_SUPERUSER_PASSWORD` in a `.env` file in the repository root. The Compose file requires this value because official images disable automatic login.
