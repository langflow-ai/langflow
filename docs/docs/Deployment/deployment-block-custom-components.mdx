...
As of Langflow 1.11.x, official Langflow Docker images set `LANGFLOW_ALLOW_CUSTOM_COMPONENTS=false` at image build time, along with related [multi-tenant component hardening](/api-keys-and-authentication#multi-tenant-component-hardening) flags.
