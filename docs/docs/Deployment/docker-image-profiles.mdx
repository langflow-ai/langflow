...
| Extended | `langflowai/langflow-all:VERSION` | `ghcr.io/langflow-ai/langflow-all:VERSION` | Default plus `langflow[bundles]`: the no-Torch long tail and opt-in standalones, including Confluent |
