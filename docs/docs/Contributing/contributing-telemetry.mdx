...
This is a telemetry event that gets sent every time a flow is executed.
...
This event is sent once when the telemetry service starts.
...
This event monitors performance and usage patterns in the Playground environment.
...
This event is sent for each component execution.
