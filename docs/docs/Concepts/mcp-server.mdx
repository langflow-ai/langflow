...
For example:
    ...
    :::important
    If your Langflow server [requires authentication](/api-keys-and-authentication) ([`LANGFLOW_AUTO_LOGIN=false`](/environment-variables#LANGFLOW_AUTO_LOGIN)), you must include your Langflow API key in the configuration.
