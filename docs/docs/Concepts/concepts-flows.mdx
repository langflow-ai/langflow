...
- **macOS OSS**: `/Users/<username>/Library/Caches/langflow`
- **Windows Desktop**: `C:\Users\<username>\AppData\Roaming\com.Langflow\cache`
- **OSS Windows/Linux/WSL (uv pip install)**: `<path_to_venv>/lib/python3.12/site-packages/langflow/cache`
- **OSS Windows/Linux/WSL (git clone)**: `<path_to_clone>/src/backend/base/langflow/cache`
