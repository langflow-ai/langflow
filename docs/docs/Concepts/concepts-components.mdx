...
The **Language Model** output can be connected to components like the [**Structured Output** component](/components-processing#structured-output) to use the LLM to power the component's reasoning.
