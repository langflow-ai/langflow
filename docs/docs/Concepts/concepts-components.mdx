...
* <Icon name="Blocks" aria-hidden="true" /> **Bundles**: These components support specific third-party integrations, and they are grouped by provider.
...
**Beta** components are newly released and still in development.
