...
For example, you could create a knowledge base with customer sales data from a specific month with the **Create Knowledge** component.
Then, when you create flows that need customer data from this time period, add a **Retrieve Knowledge** component to access the knowledge base.

## Knowledge base examples

For examples of knowledge bases in flows, see the **Create Knowledge** and **Retrieve Knowledge** [templates](/concepts-flows#create-a-flow) in Langflow.
...
The **Create Knowledge** component creates or appends rows to a [Langflow Knowledge Base](/knowledge) from a [`DataFrame`](/data-types#dataframe).
...
### Retrieve Knowledge parameters

Most **Retrieve Knowledge** component input parameters are hidden by default in the visual editor.
You can toggle parameters through the <Icon name="SlidersHorizontal" aria-hidden="true"/> **Controls** in the [component's header menu](/concepts-components#component-menus).
