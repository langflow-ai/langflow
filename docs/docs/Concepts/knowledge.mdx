...
x<!-- TODO: Use partial from big components PR after merging into docs-1.6. -->

Alternatively, you can use [knowledge bases](#knowledge-bases), which create a local vector store with built-in support for several embedding models.
