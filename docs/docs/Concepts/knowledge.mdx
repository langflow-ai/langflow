...
8. Now that your knowledge base is created, you can use the [**Knowledge Retrieval** component](/components-data#retrieve-knowledge) in any flow to search and retrieve data from the `customer-sales` knowledge base.
