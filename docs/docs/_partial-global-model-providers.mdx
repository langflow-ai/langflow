...
3. In the **API Key** field, add your provider's API key. Some providers require additional configuration fields, such as a base URL for [**OpenAI Compatible**](/bundles-openai-compatible) or [**vLLM**](/bundles-vllm). For more information, see the model provider's documentation.
