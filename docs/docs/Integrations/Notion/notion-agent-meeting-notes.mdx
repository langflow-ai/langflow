...
2. Add the components listed above to your flow, or [download the Meeting Agent flow JSON](./Meeting_Notes_Agent.json) and then [import the flow](/concepts-flows-import) into your Langflow project.
