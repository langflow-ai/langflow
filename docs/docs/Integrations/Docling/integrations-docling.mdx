...
<details>
<summary>Install Docling dependency in version 1.5.x and earlier</summary>
...
2. Connect a [**Chroma DB** vector store component](/components-bundles#chroma-db) to the **Split Text** component's **Chunks** output.
