...
To try this for yourself, create a flow based on the **Simple Agent** template, and then click <Icon name="PanelRightOpen" aria-hidden="true"/> **Playground** when editing the flow in the workspace.
