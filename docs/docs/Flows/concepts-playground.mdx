...
In Langflow 1.8, the **Playground** appears on the right side of the visual builder. The full screen option is still available by clicking the <Icon name="Fullscreen" aria-hidden="true"/> **Fullscreen** icon.

![Playground on the right side](/img/playground-right-bar.png)
