...
2. Add a [**Webhook** component](/components-io#webhook) and a [**Parser** component](/components-processing#parser) to your flow.
...
- [**Webhook** component](/components-io#webhook)
