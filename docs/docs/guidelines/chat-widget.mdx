...
<div style={{ marginBottom: "20px" }}>
  ...
  at the flow Toolbar on the bottom right corner.
</div>
...
<ZoomableImage
  ...
  sources={{
    light: useBaseUrl("img/widget-bottombar.png"),
    dark: useBaseUrl("img/widget-bottombar.png"),
  }}
...
| input_type            | String  | No       | Specifies the input type for chat messages (Default: "chat").                                                                                                    |
| output_type           | String  | No       | Specifies the output type for chat messages (Default: "chat").                                                                                                   |
| output_component      | String  | No       | Specifies which output to display if multiple outputs are available.                                                                                             |
