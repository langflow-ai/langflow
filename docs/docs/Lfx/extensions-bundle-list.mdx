...
| [`microsoft`](../Components/bundles-microsoft.mdx) (Microsoft 365) | `uv pip install lfx-microsoft` |
...
| [`serpingapi`](./bundles-serpingapi) (Serping API) | `uv pip install lfx-serpingapi` |
...
| [`anonrouter`](./bundles-anonrouter) (AnonRouter) | `uv pip install "lfx-bundles[anonrouter]"` |
...
| [`codeagents`](/bundles-codeagents) (Code Agents) | `uv pip install "lfx-bundles[codeagents]"`, then [manually install OpenDsStar](/bundles-codeagents#prerequisites) |
...
| [`figranium`](./bundles-figranium) (Figranium) | `uv pip install "lfx-bundles[figranium]"` |
