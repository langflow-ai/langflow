...
Starting in Langflow 1.12, the default `uv pip install langflow` install omits 73 provider bundles. For more information, see [Additional bundles](/extensions-bundle-list#additional-bundles).
