...
export const GraduatedBundleInstall = ({ packageName }) => {
  const providers = {
    ...
    'microsoft':          { name: 'Microsoft 365',   coreSupport: false, inDefault: true  },
    ...
    'serpingapi':         { name: 'Serping API',     coreSupport: false, inDefault: false },
    'serply':             { name: 'Serply',          coreSupport: false, inDefault: false },
    'slack':              { name: 'Slack',           coreSupport: false, inDefault: true  },
    'unirate':            { name: 'UniRate',         coreSupport: false, inDefault: false },
