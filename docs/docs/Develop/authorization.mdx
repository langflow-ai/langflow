...
- Public V1/V2 and A2A entry points continue to execute with the published flow owner's identity, under their existing visitor-isolated session and storage namespaces. Public requests cannot submit graph data or tweaks.
