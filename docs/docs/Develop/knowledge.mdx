...
**DB Providers** are the vector store backend where knowledge base embeddings are stored and searched.
To configure DB Providers, go to **Settings → DB Providers**.
