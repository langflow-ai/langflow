...
To reverse this timestamp conversion, stop all upgraded processes and use the 1.13 migration code to downgrade revision `f2a7c9e4b681` to its parent `e6f9a2b4c8d1`.
