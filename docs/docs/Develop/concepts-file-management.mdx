...
**Google Drive** storage is available through the **Read file** and **Write file** components, but can't be configured as a storage backend through environment variables as S3 can.
