...
These optional dependency groups are listed in the in the [langflow-base `pyproject.toml`](https://github.com/langflow-ai/langflow/blob/main/src/backend/base/pyproject.toml) file under `[project.optional-dependencies]`.
...
uv pip install "langflow-base[openai,chroma]" matplotlib
```
