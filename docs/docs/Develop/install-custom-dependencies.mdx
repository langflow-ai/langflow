...
## Install custom dependencies in the Langflow UI

As of Langflow version 1.6, dependency packages can be installed and uninstalled **Package Manager**.

The **Package Manager** pane is available in the **Settings** page.

This pane includes the option to **Restore Langflow**, which removes all user-installed packages and restores Langflow to the initial dependencies listed in `uv.lock`.
