...
For OpenTelemetry traces, metrics, and logs that describe Langflow service health, see [OpenTelemetry](/observability-opentelemetry).
...
For OTLP export to your own backend, see [OpenTelemetry](/observability-opentelemetry).
