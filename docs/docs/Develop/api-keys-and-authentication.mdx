...
The default is `False` for source installations, Python packages, and official Docker images.
For trusted local development, explicitly set `LANGFLOW_AUTO_LOGIN=True` to enable automatic login.
