...
* Registration endpoints (v2):
  * POST `/v2/registration/`: Register a user with email address.
  * GET `/v2/registration/`: Get the registered user, or a message if no user is registered.
