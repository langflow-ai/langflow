...
Langflow includes an OpenAI-compatible API endpoints that allow you to use your Langflow flows as if they were OpenAI models.
This enables seamless integration with existing OpenAI-compatible applications and libraries.

The OpenAI Responses API allows you to execute Langflow flows using OpenAI-compatible request and response formats.
This enables you to use existing OpenAI client libraries with minimal code changes - just change the `model` name to your `flow_id`.
