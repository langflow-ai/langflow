...
Streaming responses require your flow to contain an **Agent component** that generates streaming events during execution.
Flows without an Agent component will return empty streaming content.
