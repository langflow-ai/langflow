...
| tweaks | object | Optional. JSON body field. Component adjustments. Default: `null`. Refused keys return `422` with `TWEAKS_REFUSED`. See [Refused tweaks](/deployment-tweaks-policy#tweaks-refused). |
