...
2. At the beginning of the flow, add **Message History** and a provider-specific chat memory component.
This example uses the [**Redis Chat Memory** component](/bundles-redis).
