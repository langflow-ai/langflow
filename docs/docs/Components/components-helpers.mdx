...
It can use either your Langflow installation's storage _or_ external chat memory to store and retrieve chat messages.
...
For more information about chat memory and Langflow storage, see [Memory management options](/memory).
