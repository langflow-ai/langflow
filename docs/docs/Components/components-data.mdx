...
1. Complete the following prerequisites, if applicable:
    ...
    * **Install Linux system dependencies**: When installing Langflow manually on Linux (including custom Docker containers), you must install system packages for EasyOCR. See [Linux system dependencies](/bundles-docling#prerequisites) for details.
