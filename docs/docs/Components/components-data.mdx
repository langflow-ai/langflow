...
The Google OAuth components are deprecated.

Instead, use [Composio](/integrations/integrations-composio) to connect your flows to Google OAuth services.
:::

### Gmail Loader

:::warning Legacy Google OAuth Components
Google OAuth Components are in **Legacy**, which means they are available for use but no longer in active development.
To connect your flows to Google OAuth services, use [Composio](/integrations/integrations-composio)
:::
