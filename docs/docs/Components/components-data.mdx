...
Advanced parsing uses the Docling dependency, which is installed by default in Langflow 1.6.

For more Docling features, you can use the [**Docling** components](/integrations-docling).
