...
Most **Chat Input** input parameters are hidden by default in the visual editor.
You can enable them through the component's <Icon name="SlidersHorizontal" aria-hidden="true"/> **Controls**.
...
Most **Chat Output** input parameters are hidden by default in the visual editor.
You can enable them through the component's <Icon name="SlidersHorizontal" aria-hidden="true"/> **Controls**.
