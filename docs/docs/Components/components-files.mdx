...
Files and knowledge components help you work with files and directories in your flows.
For example:

* **Load files**: Import data from individual files or entire directories with the [**Read File** component](#read-file) and [**Directory** component](#directory).

* **Save data to files**: Write data from your flows to files in various formats with the [**Write File** component](#save-file).
