...
| Astra DB_vectorstore_kwargs | Astra DBVectorStore Parameters     | An optional dictionary of additional parameters for the Astra DBVectorStore.                                                                                |
...
| keyspace               | String       | Table Keyspace or Astra DB namespace.                    |
...
| keyspace               | Keyspace                           | The table Keyspace or Astra DB namespace. Required.                                                                                                                             |
