...
The **xAI** component is generates text using xAI models like [Grok](https://x.ai/grok).

It can output either a **Model Response** ([`Message`](/data-types#message)) or a **Language Model** ([`LanguageModel`](/data-types#language-model)).
