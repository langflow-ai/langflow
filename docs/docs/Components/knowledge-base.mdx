...
Ingest and retrieve operations use the [DB Provider](/knowledge#configure-vector-database-providers) selected when the knowledge base was created.
...
4. Connect a source component, such as a [**Read File** component](/read-file) or [**Data Operations** component](./operations) to the **Input** handle to provide the DataFrame to embed.
