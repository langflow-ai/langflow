...
4. Connect a source component, such as a [**Read File** component](/read-file) or [**Operations** component](./operations) to the **Input** handle to provide the DataFrame to embed.
