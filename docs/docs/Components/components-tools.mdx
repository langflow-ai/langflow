...
* **Python Code Structured**: Replaced by the [**Python Interpreter** component](/components-helpers#python-interpreter).
* **Python REPL**: Replaced by the [**Python Interpreter** component](/components-helpers#python-interpreter).
