...
* **Python Function**: Replaced by the [**Python Interpreter** component](/components-processing#python-interpreter).
* **Python REPL**: Replaced by the [**Python Interpreter** component](/components-processing#python-interpreter).
* **Google Search API**: Replaced by the [**Google** bundle](/bundles-google).
* **Google Serper API**: Replaced by the [**Serper** bundle](/bundles-serper).
