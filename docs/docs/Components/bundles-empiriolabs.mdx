...
This page describes the components that are available in the **EmpirioLabs AI** bundle.

For more information about EmpirioLabs AI features and functionality used by these components, see the [EmpirioLabs AI documentation](https://docs.empiriolabs.ai).

## EmpirioLabs AI text generation

This component generates text using EmpirioLabs AI language models through the EmpirioLabs OpenAI-compatible endpoints.
...
Use the **Language Model** output when you want to use an EmpirioLabs AI model as the LLM for another LLM-driven component, such as an **Agent** or **Smart Transform** component.
...
| model_name | String | Input parameter. The id of the EmpirioLabs AI model to use. The component automatically fetches the latest available models from EmpirioLabs when you provide a valid API key. For information about supported models, see the [EmpirioLabs AI documentation](https://docs.empiriolabs.ai). |
...
| model | LanguageModel | Output parameter. An instance of ChatOpenAI configured with EmpirioLabs AI parameters. |

## EmpirioLabs AI image generation

This component generates an image from a text prompt using EmpirioLabs AI image models (such as Seedream, Qwen-Image, FLUX, Nova Canvas, and HunyuanImage) through the EmpirioLabs OpenAI-compatible Images endpoint.

It outputs the API response as [`Data`](/data-types#json), including the generated image URL (or base64 content) when available.
...
| model_name | String | Input parameter. The EmpirioLabs AI image model to use for generation. The component automatically fetches the latest available image models from EmpirioLabs when you provide a valid API key. |
...
| image_generation_results | Data | Output parameter. The EmpirioLabs AI API response, including the generated image URL or base64 content. |

## Use EmpirioLabs AI in a flow

1. Sign up for an [EmpirioLabs AI account](https://empiriolabs.ai).
2. Obtain your API key from the EmpirioLabs AI dashboard.
3. In Langflow, add the **EmpirioLabs AI** component to your flow.
...
7. Add other components to your flow as needed.
    ...
    To perform a basic test, add **Chat Input** and **Chat Output** components to your flow, connect them to the **EmpirioLabs AI** component accordingly, and then click **Playground** to test the connection and chat with your model.

    For more advanced use cases, you can connect the EmpirioLabs AI component to other components like **Prompt Template**, **Agent**, or **Smart Transform** components.
