...
In Langflow version 1.7.0, the **Logic** category was renamed **Flow controls**.

Flow control components provide functionalities for routing, conditional processing, and flow management.
