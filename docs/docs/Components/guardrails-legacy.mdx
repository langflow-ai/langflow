...
This legacy component preserves existing flows. For new flows, use [Guardrails](/guardrails); its default **AI checks** method uses the same evaluator. Upgrading a saved flow is explicit.
