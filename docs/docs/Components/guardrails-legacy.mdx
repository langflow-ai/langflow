---
title: Guardrails (Legacy)
slug: /guardrails-legacy
---

import Icon from "@site/src/components/icon";
import PartialParams from '@site/docs/_partial-hidden-params.mdx';

This legacy component preserves existing flows. For new flows, use [Guardrails](./guardrails.mdx); its default **AI checks** method uses the same evaluator. Upgrading a saved flow is explicit.
