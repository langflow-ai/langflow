...
| max_content_length | Max Content Length | Input parameter. Maximum number of characters kept from each scraped page. Set to `0` to keep the full page text. Default: `2000`. |
