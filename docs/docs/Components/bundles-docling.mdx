...
The Docling dependency is required to use the Docling components in Langflow.
    ...
    * **Platform note**: For macOS Intel (x86_64), use the [Docling installation guide](https://docling-project.github.io/docling/installation/) to install the Docling dependency.
