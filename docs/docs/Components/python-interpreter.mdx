...
To pass inputs to the **Python Interpreter** component, you need to customise the component's code to add input fields.
...
3. To modify the component code to pass a URL value to the **Python Interpreter** component, make the following code changes:
...
6. Connect the **Text** component's output to the **URL** input field of the custom **Python Interpreter** component.

The **Python Interpreter** component can now use the `url` variable directly in your Python code.
