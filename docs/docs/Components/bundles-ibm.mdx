...
For IBM Confluent (Kafka, Flink, Tableflow, and the Real-Time Context Engine) — the data-in-motion half of IBM's streaming lakehouse — see the [**IBM Confluent** bundle](/bundles-confluent).
...
* [**IBM Confluent** bundle](/bundles-confluent)
