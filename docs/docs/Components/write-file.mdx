...
2. Click **Storage Location** and choose **Local**, **AWS** or **Google Drive**.
    Enter your cloud provider's credentials.
    For more information on configuring Langflow storage, see [Configure file storage](/concepts-file-management#configure-file-storage).
