...
To configure OpenRouter once for all flows, you can also use the [**OpenAI Compatible**](./bundles-openai-compatible) model provider with the base URL `https://openrouter.ai/api/v1`.
