...
LLM operations components use attached [**Language model** components](/language-models) to make decisions.
For example:
...
The **Smart Router** component is an LLM-powered variation of the [**If-Else** component](/components-logic#if-else).
...
For an example, create [If-Else component example flow](/components-logic#use-the-if-else-component-in-a-flow), then replace the **If-Else** component with a **Smart Router** component.
