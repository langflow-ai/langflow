...
| agent_type | String | Input parameter. The agent type to create (see LangChain docs for supported values, for example `zero-shot-react-description`, `openai-functions`, `openai-tools`). |
