...
:::warning Security
Setting `allow_dangerous_code` to `true` allows the agent to execute arbitrary, LLM-generated Python code at runtime on the Langflow server. This code can do anything that Python can do, including file access, so use this option only with trusted data and in a secure environment. For more information, see [CVE-2024-21513](https://nvd.nist.gov/vuln/detail/CVE-2024-21513) (langchain-experimental arbitrary code execution).
:::
