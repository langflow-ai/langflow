...
2. Add the **Language Model** core component to your flow, and then select your configured model from the **Language Model** field.
...
10. Optional: Try a different model or provider to see how the response changes.
    ...
    If you enabled multiple models in Langflow's global <Icon name="BrainCog" aria-hidden="true" /> **Models**, select a different model in the **Language Model** field. Or, click <Icon name="BrainCog" aria-hidden="true" /> **Models** in the Langflow header to configure additional models and providers.
