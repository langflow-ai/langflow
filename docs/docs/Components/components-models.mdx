...
2. Add the **Language Model** core component to your flow, and then select your configured model from the **Language Model** dropdown.

    The **Language Model** dropdown includes the following options at the bottom:
...
For example, if you are using the **Language Model** core component, you could try an Anthropic model.
    ...
    2. Add the API key for another provider (if not already configured), and then select the model you want to try.
    3. Return to your flow and select the new model from the **Language Model** component's dropdown.
...
4. Add an **Agent** component to the flow, and then set **Model Provider** to **Connect other models** in the **Language Model** dropdown.
...
|------|------|-------------|
| provider | String | Input parameter. The model provider to use. Models are configured globally in the **Models** pane. |
| model_name | String | Input parameter. The name of the model to use. Options depend on the selected provider and are configured globally in the **Models** pane. |
