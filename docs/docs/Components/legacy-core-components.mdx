...
Replace this legacy component with the [**Operations** component](/operations).
...
Replace this legacy component with the [**Operations** component](/operations) or the [**Loop** component](/loop).
...
<details>
<summary>Data Operations, DataFrame Operations, and Text Operations</summary>

Replace these legacy components with the [**Operations** component](/operations), which provides a unified interface for Text, Data, and DataFrame operations.
...
Replace this legacy component with the [**Operations** component](/operations) or [**Parser** component](/parser).
