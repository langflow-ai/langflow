...
Replace this legacy component with the [**Operations** component](./operations). Set **Input Type** to `JSON`.
...
Replace this legacy component with the [**Operations** component](./operations). Set **Input Type** to `JSON`, or the [**Loop** component](/loop).
...
Replace these legacy components with the [**Operations** component](./operations), which provides a unified interface for Text, JSON, and Table operations.
Set **Input Type** on the **Operations** component to match the data you need to process.
For more information, see the [**Operations** component](./operations) documentation.
...
Replace these legacy components with newer Processing components, such as the [**Operations** component](./operations) and [**Type Convert** component](/type-convert).
...
Replace this legacy component with the [**Operations** component](./operations). Set **Input Type** to `Table`, or the [**Parser** component](/parser).
