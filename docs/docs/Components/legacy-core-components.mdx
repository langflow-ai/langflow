...
Replace this legacy component with the [**Read File** component](/read-file).

The **Directory** component recursively loaded files from a directory path on the local machine, with options for file types, depth, and concurrency.
