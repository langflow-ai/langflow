...
## Use the Knowledge Ingestion component in a flow {#usage-example}
...
2. In the **Knowledge** field, select <Icon name="Plus" aria-hidden="true"/> **Create new knowledge** to create a new knowledge base, or select one of your existing knowledge bases.
...
3. If you selected <Icon name="Plus" aria-hidden="true"/> **Create new knowledge**, configure your new knowledge base, and then click **Create**.
    ...
    * **Choose Embedding**: Select an embedding model to genenerate embeddings for your data.
    This cannot be changed later.
        ...
        For more information, see the [**Embedding model** component](/components-embedding-models).

    To add a new model or manage your global embedding model configuration, click <Icon name="Settings" aria-hidden="true"/> **Manage Model Providers**.
...
* [**Knowledge Retrieval** component](/knowledge-retrieval)