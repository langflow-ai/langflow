...
2. In the **Knowledge** field, select <Icon name="Plus" aria-hidden="true"/> **New knowledge** to create a new knowledge base, or select one of your existing knowledge bases.
...
3. If you selected <Icon name="Plus" aria-hidden="true"/> **New knowledge**, configure your new knowledge base, and then click **Create**.
