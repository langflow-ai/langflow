...
The **Smart Transform** component uses an LLM to generate a Lambda function to filter or transform structured data or messages based on natural language instructions.
...
The LLM runs the function against the data or message input, and then outputs the results as [`Data`](/data-types#data), [`DataFrame`](/data-types#dataframe), or [`Message`](/data-types#message).
...
|------|--------------|------|
| data | Data | Input parameter. The structured data or messages to filter or transform using a Lambda function. Accepts [`Data`](/data-types#data), [`DataFrame`](/data-types#dataframe), or [`Message`](/data-types#message) types. |
