...
### AI/ML text generation parameters

Many **AI/ML** component input parameters are hidden by default in the visual editor.
...
## AI/ML API embedding generation
...
### AI/ML API embedding generation parameters
