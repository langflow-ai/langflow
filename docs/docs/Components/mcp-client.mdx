...
To manage all MCP server connections for your Langflow client, click <McpIcon aria-hidden="true"/> **MCP servers** in the visual editor, or click your profile icon, select **Settings**, and then click **MCP Servers**.
