...
To manage all MCP server connections for your Langflow client, click ![](/logos/mcp-icon.svg) **MCP servers** in the visual editor, or click your profile icon, select **Settings**, and then click **MCP Servers**.
