...
**ScyllaDB is a drop-in replacement for Apache Cassandra** in Langflow. All Cassandra components work with ScyllaDB without any code modifications. Simply update the `database_ref` parameter to point to your ScyllaDB cluster instead of Cassandra.
