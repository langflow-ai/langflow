...
The **Plivo Send SMS** component sends an SMS message through the [Plivo Messaging API](https://www.plivo.com/docs/messaging/api/messages?utm_source=github&utm_medium=oss&utm_campaign=langflow-plivo).
