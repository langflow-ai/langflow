...
## DataStax vector store components
...
The **Astra DB** component read and writes to [Astra DB Serverless databases](https://docs.datastax.com/en/astra-db-serverless/index.html), using an instance of `AstraDBVectorStore` to call the Data API and DevOps API.
...
<details>
<summary>Use the Astra DB component in a flow</summary>
...
Replace it with the [**Astra DB** component](/components-vector-stores#astra-db).
