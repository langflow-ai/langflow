...
For information about Vertex AI components, see the [Vertex AI bundle](/bundles-vertexai) and [Integrate Google Cloud Vertex AI with Langflow](/integrations-setup-google-cloud-vertex-ai-langflow).
