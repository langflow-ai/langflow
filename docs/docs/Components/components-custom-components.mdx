...
## Distribute components as a bundle

If you want to share your custom components with others or publish them as a reusable integration, package them as an **Extension Bundle**.
For the full guide, see [Contribute component bundles](/contributing-bundles).
