...
The following archive file types are supported by the **Read File** component.
...
2. Add one valid file to the **Read File** component.
    ...
    * Advanced parsing and the **Read File** component accept different sets of file formats.
    If a file type is supported by **Read File** but not by **Docling**, disable advanced parsing in the **Read File** component.
    If **Docling** supports a type that **Read File** does not, use the dedicated **Docling** components.

    <details>
    <summary>Advanced parsing file types</summary>

    The following file types are supported by the [**Docling**](https://docling-project.github.io/docling/) library and the **Read File** component when advanced parsing is available for that file type.
