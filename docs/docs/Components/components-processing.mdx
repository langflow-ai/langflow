...
* Filter data with natural language with the [**Smart Transform** component](/components-llm-operations#smart-transform).
...
* Save data to your local machine with the [**Write File** component](/components-files#save-file).
