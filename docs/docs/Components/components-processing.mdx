...
* Filter data with natural language with the [**Smart Transform** component](#smart-function).
...
1. Create a new flow or use an existing flow.
    ...
    2. Configure the [**Smart Transform** component](#smart-function) and its dependencies:
