...
As of Langflow version 1.5, the **Python Interpreter** component replaces the following legacy Python components.
You can still use these components in your flows, but they are no longer supported and can be removed in a future release.
