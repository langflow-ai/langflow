...
The Memory Base component retrieves context from a [memory base](/memory-base) attached to the current flow using semantic search.
The most relevant conversation chunks are returned as as a [DataFrame](/data-types#dataframe).
