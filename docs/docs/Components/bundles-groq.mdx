...
1. To use this component in a flow, connect it as a **Model** in a flow like the [Basic prompting flow](/basic-prompting), or select it as the **Model Provider** in an **Agent** component.
<!-- Verify what "connect as a model" means -->
