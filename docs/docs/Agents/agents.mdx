...
If you select <Icon name="Plus" aria-hidden="true"/> **Connect Other Models** as the model provider, authentication is handled in the incoming **Language Model** component.
