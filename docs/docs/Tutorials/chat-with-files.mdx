...
:::tip
For an example of constructing file upload requests in JavaScript, see the [Create a vector RAG chatbot tutorial](/chat-with-rag#chat-with-your-flow-from-a-javascript-application).
:::
