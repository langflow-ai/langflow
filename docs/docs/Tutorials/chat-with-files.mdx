...
5. Add a [**Read File** component](/components-files#read-file) to the flow, and then connect the **Raw Content** output port to the **Prompt Template** component's **file** input port.
...
You can also use a [**Directory** component](/components-files#directory) to load all files in a directory or pass an archive file to the **Read File** component.
