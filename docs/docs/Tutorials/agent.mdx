...
The following steps modify the **Simple Agent** template to connect a [**Directory** component](/components-files#directory) and a [**Web Search** component](/components-data#web-search) as tools for an **Agent** component.
