...
4. In the [header menu](/concepts-components#component-menus) for both the **Directory** and **Web Search** components, enable **Tool Mode** so you can use the components with an agent.
...
1. To include the email address as a value in your flow, add a [**Prompt Template** component](/components-prompts) to your flow between the **Chat Input** and **Agent**.
