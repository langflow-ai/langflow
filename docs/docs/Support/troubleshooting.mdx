...
For details on which features are available and workarounds, see [macOS support](/macos-support).
...
For more information, see [Workarounds for Intel Mac users](/macos-support#workarounds-for-intel-mac-users).
