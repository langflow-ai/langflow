...
If there is no text box for input in the Playground, make sure your flow has an [Input component](/components-io) that is connected to the **Input** port of another component.
