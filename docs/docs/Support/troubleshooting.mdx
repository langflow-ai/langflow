...
This requirement does not apply to Apple Silicon Macs on ARM64.

To resolve this issue, install `protoc` using `brew install protobuf`.

For more information, see the [Protocol buffers installation documentation](https://protobuf.dev/installation/).
