...
- Email registration in Langflow Desktop
    ...
    Langflow Desktop now includes an email registration screen at startup. This registration is used to track user engagement and help improve Langflow. For more information, see [Telemetry](/contributing-telemetry#email).
