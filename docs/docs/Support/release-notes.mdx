...
- New [**Langflow Assistant** documentation](/components/langflow-assistant)

    Added a dedicated documentation page for **Langflow Assistant**, including setup requirements, graph-aware behavior, and a worked custom component example.
