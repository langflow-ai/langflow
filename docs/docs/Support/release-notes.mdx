...
- New unified **Operations** component

    A new unified [**Operations** component](/operations) consolidates Text Operations, Data Operations, and DataFrame Operations into a single component.
    For more information, see the [**Operations** component](/operations).
...
- New integrations, bundles, and components:
  ...
  New filter operator for **Operations** component

    The [**Operations** component](/operations) now includes a `not contains` filter operator.
  ...
  New JSON operations for **Operations** component

    The [**Operations** component](/operations) now includes two operations for advanced JSON data manipulation.
