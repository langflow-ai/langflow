...
- Knowledge bases
  ...
  For more information, see Knowledge base components.
...
- Reorganized component menus and visual editor controls
  ...
  - Click <McpIcon /> **MCP servers** to manage all of your MCP server connections without leaving the workspace.
...
- Increased default maximum file upload size from `100 MB` to `1024 MB`.
