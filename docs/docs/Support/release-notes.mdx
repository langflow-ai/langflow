...
- [**Langflow Assistant**](/components/langflow-assistant)

    **Langflow Assistant** is a graph-aware co-pilot that can create flows and components from natural language prompts, directly within the Langflow workspace.
    For more information, see [**Langflow Assistant** documentation](/components/langflow-assistant).
