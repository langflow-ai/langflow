...
- Built-in Docling support
    ...
    You don't need to manually install it to use the Docling components or the File component's advanced parsing feature.
...
- Structured output option for the **Agent** component
  ...
  The output can be controlled in the component's ** **
