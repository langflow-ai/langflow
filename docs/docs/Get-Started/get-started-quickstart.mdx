...
<Cards cols={2}>
  <Card icon={<Icon name="Zap" size={20} />} title="Trigger flows with the API" href="/concepts-publish">
    Run your flows programmatically from external applications.
  </Card>
  <Card icon={<Icon name="Plug" size={20} />} title="MCP server" href="/mcp-server">
    Use Langflow as a Model Context Protocol server.
  </Card>
  <Card icon={<Icon name="Container" size={20} />} title="Containerize your app" href="/develop-application">
    Deploy Langflow as a containerized application.
  </Card>
  <Card icon={<Icon name="FolderOpen" size={20} />} title="File management" href="/concepts-file-management">
    Learn how Langflow handles files and storage.
  </Card>
</Cards>