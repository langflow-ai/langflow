...
Replace this legacy component with the [**Data Operations** component](/1.8.0/data-operations).
...
Replace this legacy component with the [**Data Operations** component](/1.8.0/data-operations) or the [**Loop** component](/loop).
...
Replace these legacy components with newer Processing components, such as the [**Data Operations** component](/1.8.0/data-operations) and [**Type Convert** component](/type-convert).
...
Replace this legacy component with the [**DataFrame Operations** component](/1.8.0/dataframe-operations) or [**Parser** component](/parser).
