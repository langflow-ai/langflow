...
For example, if you are looping over a `Table`, you could use multiple [**Table Operations** components](/1.9.0/dataframe-operations) to conditionally filter data, and then run separate loops on each set of filtered data.
