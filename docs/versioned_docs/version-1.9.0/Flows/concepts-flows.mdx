...
When restoring a saved version, keep **Save current draft before restoring** enabled to create a backup of your current work before the selected version replaces it.
