...
- Renamed **Data Operations** and **DataFrame Operations** components
    ...
    The **Data Operations** component is now the [**JSON Operations** component](/1.9.0/data-operations), and the **DataFrame Operations** component is now the [**Table Operations** component](/1.9.0/dataframe-operations).
