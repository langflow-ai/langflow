...
For JWT authentication configuration, including algorithm selection and key management, see [JWT authentication](/1.10.0/jwt-authentication).
...
For JWT-specific configuration, see [JWT authentication](/1.10.0/jwt-authentication).
