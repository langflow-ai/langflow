...
2. Add a **Table Operations** component to the flow, and then connect `Table` output from another component to the **Table** input.
    ...
    Alternatively, you could consider using a component that is designed to process the original data type, such as the [**Parser** component](/parser) or [**JSON Operations** component](/1.10.0/data-operations).
