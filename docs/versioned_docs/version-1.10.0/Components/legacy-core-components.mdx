...
Replace this legacy component with the [**JSON Operations** component](/1.10.0/data-operations).
...
Replace this legacy component with the [**JSON Operations** component](/1.10.0/data-operations) or the [**Loop** component](/loop).
...
Replace these legacy components with newer Processing components, such as the [**JSON Operations** component](/1.10.0/data-operations) and [**Type Convert** component](/type-convert).
...
Replace this legacy component with the [**Table Operations** component](/1.10.0/dataframe-operations) or [**Parser** component](/parser).
