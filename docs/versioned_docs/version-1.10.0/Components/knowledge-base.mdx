...
4. Connect a source component, such as a [**Read File** component](/read-file) or [**JSON Operations** component](/1.10.0/data-operations) to the **Input** handle to provide the DataFrame to embed.
