...
There are several ways you can address these inconsistencies:
    ...
    * Use other components to amend or filter anomalies before passing the data to the **Parser** component.
    There are many components you can use for this depending on your goal, such as the [**JSON Operations** component](/1.10.0/data-operations), [**Structured Output** component](/structured-output), and [**Smart Transform** component](/smart-transform).
